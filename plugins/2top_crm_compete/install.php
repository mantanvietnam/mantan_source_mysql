...
$sqlInstallDatabase .= "CREATE TABLE `reports` ( `id` INT NOT NULL AUTO_INCREMENT , `id_customer` INT NOT NULL , `id_target` INT NOT NULL , `image` VARCHAR(255) NOT NULL , `note` TEXT CHARACTER SET utf8 COLLATE utf8_vietnamese_ci NOT NULL , `time_report` INT NOT NULL , `point` INT NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB; ; ";
