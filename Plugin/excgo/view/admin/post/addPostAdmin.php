                        ...
                        <div class="tab-pane fade active show" id="navs-top-home" role="tabpanel">
                            <div class="row">
                                ...
                                <div class="mb-3 col-12 col-sm-12 col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="number_order" value="<?php echo @$infoPost->number_order;?>" />
                                    </div>
                            ...
                            <div class="row">
                              <?php if(!empty($listProvince)){
                                foreach($listProvince as $key => $item){
                                    $checks = '';
                                    if(!empty($listPost[$item->id])){
                                              $checks = 'checked';
                                            }
                                    echo '<div class="mb-3 col-md-3"><input type="checkbox" '.$checks.' name="province_id['.$item->id.']" value="'.$item->id.'"> <label class="form-label">'.$item->name.' ('.$item->bsx.')</label></br>
                                        <input type="text" class="form-control" name="number_province['.$item->id.']" value="'.@$listPost[$item->id].'" />
                                    ';
