                      ...
                      <div class="right-content-writetitle d-flex">
                        ...
                        <div class="out-like-blogpro">
                          <div class="write-outline">
                            <h3>Tái chế nội dung kịch bản Video có sắn</h3>
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                    <form action="" method="post">
                      ...
                      <div>
                        <div class="mb-3">
                          <label for="text" class="form-label">Sản phẩn và dịch vụ</label>
                          <textarea type="text" placeholder="VD: sữa rủa mặt...." class="form-control" id="topic" name="topic" rows="2" cols="30"></textarea>
...
<script type="text/javascript">
    ...
    function sendquestionNet(i){
      ...
      if(conversation_id != '' && conversation_id!='0'){
             $.ajax({
          method: "POST",
          url: "/apis/chatContentVideoScriptAPI",
          data: {question: '',
    ...
    function chatquestion(){
     ...
     function saveContentBlog(){
      ...
      if(conversation_id != '' && question!=''){
             $.ajax({
          method: "POST",
          url: "/apis/saveContentVideoScriptAPI",
