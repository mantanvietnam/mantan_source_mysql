                    ...
                    <form action="" method="post">
                      ...
                      <div class="mb-3">
                        <select class="form-select" name="target_ads" id="target_ads" aria-label="Default select example">
                          ...
                          <option value="Tăng lượt truy cập website">Tăng lượt truy cập website</option>
                          <option value="Tạo khách hàng tiềm năng">Tạo khách hàng tiềm năng</option>
                          <option value="Tăng tương tác">Tăng tương tác</option>
                          <option value="Tạo nhận thức về sản phẩm mới">Tạo nhận thức về sản phẩm mới</option>
                          <option value="Tăng lượt tải ứng dụng (App Installations)">Tăng lượt tải ứng dụng (App Installations)</option>
                        </select>
                      </div>
                      ...
                      <div>
                        <div class="mb-3">
                          <label for="text" class="form-label">Nhập chiến dịch quảng cáo của bạn</label>
                          <textarea type="text" placeholder="VD: chiến dịch quảng cáo kem đánh răng" class="form-control" id="topic" name="topic" rows="2" cols="30"></textarea>
                ...
                <div id="collapseTwo1" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                    <form action="" method="post">
                      ...
                      <button type="button" class="button-arcordian" onclick="sendquestionNet('title')" id="showAiThinking">Tạo nội dung</button>
                    </form>
                  </div>
                </div>
              </div>
                ...
                <div id="collapseTwo2" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                    <form action="" method="post">
                      ...
                      <button type="button" class="button-arcordian" onclick="sendquestionNet('content')" id="showAiThinking">Tạo nội dung</button>
                    </form>
                  </div>
                </div>
              </div>
        ...
        <div class="right-form-wirte-content">
          <form action="" method="post">
            ...
            <div class="show-input-editor">
              ...
              <!-- <textarea type="text" placeholder="" class="form-control" id="result" name="result" rows="15" cols="30"><?php echo  @$result; ?></textarea> -->
            </div>
...
<script type="text/javascript">
    ...
    function sendquestion(){
       aiThinking.classList.remove('d-none');
        ...
        $.ajax({
          method: "POST",
          url: "/apis/sendContentGooglAdsAPI",
          data: {topic: topic,
                target:target, 
        }
    }).done(function( msg ) {
...
<script type="text/javascript">
    ...
    function sendquestionNet(i){
      ...
      if(conversation_id != '' && conversation_id!='0'){
             $.ajax({
          method: "POST",
          url: "/apis/chatContentGooglAdsAPI",
          data: {question: '',
    ...
    function chatquestion(){
     ...
     function saveContentGoogleAds(){
      ...
      if(conversation_id != '' && question!=''){
             $.ajax({
          method: "POST",
          url: "/apis/saveContentGooglAdsAPI",
