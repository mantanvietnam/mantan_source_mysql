                    ...
                    <form action="" method="post">
                      ...
                      <div>
                        <div class="mb-3">
                          ...
                          <textarea type="text" placeholder="Dán vào dối tượng khách hàng của tôi là" class="form-control" id="customer_target" name="customer_target" rows="2" cols="30"></textarea>
                        </div>
                      </div>
                      <div>
                        <div class="mb-3">
