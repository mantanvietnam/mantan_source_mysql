                ...
                if(!empty($listData)){
                  foreach ($listData as $item) {
                    ...
                    echo '<tr>
                            ...
                            <td align="center">
                              <a class="dropdown-item" href="/plugins/admin/phoenix_ai-view-admin-member-addMemberAdmin/?id='.$item->id.'">
                                <i class="bx bx-edit-alt me-1" style="font-size: 22px;"></i>
                              </a>
                            </td>

                            <td align="center">
                              <a class="dropdown-item" onclick="return confirm(\'Bạn có chắc chắn muốn xóa không?\');" href="/plugins/admin/phoenix_ai-view-admin-member-deleteMemberAdmin/?id='.$item->id.'">
