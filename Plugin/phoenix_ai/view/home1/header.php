      ...
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/ai-virtual-assistant"><i class='bx bx-bug-alt'></i> AI trợ lý ảo</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="/ai-create-clip"><i class='bx bxl-youtube'></i> AI tạo clip</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="/ai-create-image"><i class='bx bx-image-alt' ></i> AI tạo ảnh</a>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="/ai-create-content"><i class='bx bx-edit' ></i> AI viết bài</a>
            </li>
