...
function sendinspirationalfacebookAPI($input){
    ...
    global $modelCategories;
     ...
     if(!empty($session->read('infoUser'))){
        ...
        $modelinspirationalfacebookAis = $controller->loadModel('inspirationalfacebookAis');
...
function saveinspirationalfacebookAPI($input){
    ...
    if(!empty($session->read('infoUser'))){
        ...
        $modelinspirationalfacebookAi = $controller->loadModel('inspirationalfacebookAis');
        ...
        if($isRequestPost){
            ...
            $checkContent = $modelinspirationalfacebookAi->find()->where(['conversation_id'=>$dataSend['conversation_id'],'type'=>'content_facebook'])->first();
...
function sendinspirationalfacebookAdsAPI($input){
    global $isRequestPost;
    global $controller;
    global $session;
    global $modelCategoryConnects;
...
function chatinspirationalfacebookAdsAPI($input){
    global $isRequestPost;
    global $controller;
    global $session;
    global $modelCategoryConnects;
...
function saveinspirationalfacebookAdsAPI($input){
    global $isRequestPost;
    global $controller;
    global $session;
    global $modelCategoryConnects;
