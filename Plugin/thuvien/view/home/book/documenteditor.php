...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">Biên tập tài liệu</h4>
                        ...
                        if(!empty($listData)){
                          foreach ($listData as $item) {
                            echo '<tr>
                                    ...
                                    <td align="center">
                                      <a class="dropdown-item"  onclick="deleteCategory('.$item->id.');">
  ...
  <script type="text/javascript">
    ...
    function deleteCategory(id){
      ...
      if(check){
        $.ajax({
          method: "GET",
          url: "/deletedocumenteditor?id="+id,
          data: {}
        })
          .done(function( msg ) {
            window.location = '/documenteditor';
          })
          .fail(function() {
            window.location = '/documenteditor';
          });
