        ...
        <tbody>
          ...
          if(!empty($listData)){
            foreach ($listData as $item) {
              ...
              <a class="dropdown-item" href="/addMember/?id='.$item->id.'">
              <i class="bx bx-edit-alt me-1"></i>
              </a>
              </td>

              <td align="center">
              <a class="dropdown-item" onclick="return confirm(\'Bạn có chắc chắn muốn xóa không?\');" href="/deleteMember/?id='.$item->id.'">
