...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light"><a href="/listCustomer">Người mượn sách</a> /</span>
...
<form method="get" action="">
  <div class="card mb-4">
    <h5 class="card-header">Tìm kiếm người mượn</h5>
    <div class="card-body">
...
<!-- Responsive Table -->
<div class="card row">
  <h5 class="card-header">Danh sách người mượn sách - <span class="text-danger"><?php echo number_format(@$totalData); ?> người</span></h5>
  <?php echo @$mess; ?>
      ...
      <tbody>
        ...
        if (!empty($listData)) {
          foreach ($listData as $item) {
            ...
            <td align="center">
              <a class="dropdown-item" onclick="return confirm(\'Bạn có chắc chắn muốn xóa không?\');" href="/deleteCustomer/?id='.$item->id.'">
