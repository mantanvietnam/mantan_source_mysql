    ...
    <div class="row table-responsive">
      <div class="col-12">
        <div class="card-body">
          ...
          <p>Link api: https://domain/apis/saveDonateAPI</p>
          ...
          <p><b>id_charity</b>: ID chiến dịch từ thiện</p>
          <p><b>coin</b>: Số tiền đóng góp</p>
          <p><b>image</b>: Link ảnh lưu niệm</p>
          <p><b>note</b>: Lời nhắn</p>
        </div>
      </div>
    </div>
  </div>
