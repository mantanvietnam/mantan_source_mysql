<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <p><a href="/plugins/admin/2top_crm_donate-view-admin-donate-addDonateCharityCRM" class="btn btn-primary"><i class='bx bx-plus'></i> Thêm mới</a></p>
            ...
            if(!empty($listData)){
              foreach ($listData as $item) {
                ...
                echo '<tr>
                        ...
                        <td>'.$note.'</td>
                        <td align="center">
                          <a class="dropdown-item" href="/plugins/admin/2top_crm_donate-view-admin-donate-addDonateCharityCRM/?id='.$item->id.'">
                            <i class="bx bx-edit-alt me-1"></i>
                          </a>
                        </td>

                        <td align="center">
                          <a class="dropdown-item" onclick="return confirm(\'Bạn có chắc chắn muốn xóa không?\');" href="/plugins/admin/2top_crm_donate-view-admin-donate-deleteDonateCharityCRM/?id='.$item->id.'">
