<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4">Thông tin Mediapress</h4> 
  <p><a href="/plugins/admin/project-view-admin-mediapre-addMediapreAdmin" class="btn btn-primary"><i class='bx bx-plus'></i> Thêm mới</a></p>
            ...
            if(!empty($listData)){
              foreach ($listData as $project_item) {
                ...
                echo '<tr>
                        ...
                        <td align="center">
                          <a class="dropdown-item" href="/plugins/admin/project-view-admin-mediapre-addMediapreAdmin/?id='.$project_item->id.'">
