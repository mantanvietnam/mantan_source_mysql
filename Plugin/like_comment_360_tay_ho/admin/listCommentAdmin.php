              ...
              foreach ($listData as $item) {
                ...
                echo '<tr>
                       ...
                       <td align="center">
                        ...
                        <td align="center">
                          <a class="dropdown-item" onclick="return confirm(\'Bạn có chắc chắn muốn xóa không?\');" href="/plugins/admin/like_comment_360_tay_ho-deleleCommentAdmin/?id='.$item->id.'">
               ...
               ?>
                        <div class="modal fade" id="basicModal<?php echo $items->id; ?>"  name="id">
                          ...
                          <div class="modal-dialog" role="document">
                            ...
                            <form action="/plugins/admin/like_comment_360_tay_ho-admin-replyCommentAdmin" method="GET">
