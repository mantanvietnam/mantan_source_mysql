                      ...
                      <?php 
                        if(!empty($listData)){
                          foreach ($listData as $item) {
                            echo '<tr>
                                    <td><a target="_blank" href="/training/'.$item->slug.'.html">'.$item->name.'</a></td>
                                    <td align="center">
          ...
          <div class="card mb-6">
            ...
            <div class="card-body">
              <?= $this->Form->create(); ?>
                ...
                <div class="mb-3">
                  <label class="form-label" for="basic-default-phone">Tên tiêu chí</label>
                  <input
                    type="text"
