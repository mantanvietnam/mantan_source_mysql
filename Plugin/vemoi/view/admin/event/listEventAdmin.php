<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4">Sự kiện</h4>
              ...
              <?php 
                if(!empty($listData)){
                  foreach ($listData as $item) {
                    ...
                    echo '<tr>
                            <td>'.$item->id.'</td>
                            <td><img src="'.$item->banner.'" width="100" /></td>
                            <td>
                              '.$item->name.'<br/>
                              '.$item->address.'
                            </td>
                            ...
                            <td align="center">
                              <a class="dropdown-item" onclick="return confirm(\'Bạn có chắc chắn muốn xóa không?\');" href="/plugins/admin/vemoi-view-admin-event-deleteEventAdmin/?id='.$item->id.'">
                  ...
                  echo '<tr>
                          <td colspan="10" align="center">Chưa có sự kiện</td>
                        </tr>';
                }
              ?>
            </tbody>
