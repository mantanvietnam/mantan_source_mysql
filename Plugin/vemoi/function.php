...
function sendEmailCodeCheckin($email = '', $data = '', $code = '',$inforuser= '')
{
    $to = array();
    ...
    if (!empty($email)) {
        ...
        $cc = array();
        $bcc = array();
        $subject = 'Đăng ký tham gia sự kiện '.$data->name.' thành công';
        ...
        <body>
            <div class="bao">
                <div class="nd">
                    <div class="head">
                        <span>Đăng ký tham gia sự kiện '.@$data->name.' thành công</span>
                    </div>
                    <div class="main">
                        <em style="    margin: 10px 0 10px;display: inline-block;">Xin chào ' .@$inforuser->name. ' !</em> <br>
