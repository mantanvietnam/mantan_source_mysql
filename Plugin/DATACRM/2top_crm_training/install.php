...
$sqlInstallDatabase .= "CREATE TABLE `historytests` ( `id` INT NOT NULL AUTO_INCREMENT , `id_customer` INT NOT NULL , `id_test` INT NOT NULL , `point` FLOAT NOT NULL , `total_true` INT NOT NULL , `number_question` INT NOT NULL , `time_start` INT NOT NULL , `time_end` INT NOT NULL , `status` VARCHAR(255) NOT NULL, PRIMARY KEY (`id`)) ENGINE = InnoDB;";
...
$sqlUpdateDatabase .= "ALTER TABLE `courses` ADD `public` BOOLEAN NOT NULL DEFAULT FALSE AFTER `content`; ";
?>