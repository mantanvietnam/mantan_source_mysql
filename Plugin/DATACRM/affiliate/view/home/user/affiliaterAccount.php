              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="mb-3">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <img class="mb-3" id="QRURLProfile" src="https://api.qrserver.com/v1/create-qr-code/?size=500x500&data=<?php echo $urlHomes.'book-online/?aff='.@$data->phone;?>" width="100">
                      </div>
                      <div class="col-md-6">
                        <button type="button" class="btn btn-primary mb-3" onclick="copyToClipboard('<?php echo $urlHomes.'book-online/?aff='.@$data->phone;?>', 'Đã copy thành công link liên kết');"><i class='bx bx-link'></i> Sao chép liên kết</button>

                        <button type="button" class="btn btn-danger mb-3" onclick="downloadImageFromSrc('https://api.qrserver.com/v1/create-qr-code/?size=500x500&data=<?php echo $urlHomes.'book-online/?aff='.@$data->phone;?>', '<?php echo $data->phone;?>');"><i class='bx bx-cloud-download'></i> Tải mã QR</button>
                      </div>
                    </div>
                  </div>
                </div>
