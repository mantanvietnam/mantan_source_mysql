                    ...
                    <div class="top row">
                        <div class="left col-md-10">
                            ...
                            <div class="input-group">
                                <input type="text" name="time" id="time" value="<?php echo date('H:i d/m/Y', $order->create_at)?>" class="form-control datetimepicker"  required />
                            </div>
                        </div>    
                    </div>
                            ...
                            <div class="info-bh">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <p><?php echo $customer->full_name.' '.$customer->phone ?></p>
...
function createOrder()
{
    ...
    if(numberProduct>0){
        if(id_customer != '' && id_customer!='0'){
            r = confirm("Bạn muốn lưu yêu cầu nhập hàng cho Khách hàng đúng không?");
            if (r == true) {
                if(checkProduct){
                    $('#summary-form').submit();
                }
