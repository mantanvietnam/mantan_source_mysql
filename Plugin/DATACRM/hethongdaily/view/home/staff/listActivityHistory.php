...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <h4 class="fw-bold py-3 mb-4">
    ...
    Danh sách lịch sử hàng động nhân viên
  </h4>
  <!-- Form Search -->
      ...
      <div class="card-body">
        <div class="row gx-3 gy-2 align-items-center">
          ...
          <div class="col-md-3">
            ...
            <input type="text" class="form-control" name="name_staff" id="name_staff" value="<?php if(!empty($_GET['name_staff'])) echo $_GET['name_staff'];?>">
            <input type="hidden" class="form-control" name="id_staff" id="id_staff" value="<?php if(!empty($_GET['id_staff'])) echo $_GET['id_staff'];?>">
          </div>
  ...
  <!-- Responsive Table -->
  <div class="card row">
    <h5 class="card-header">Danh sách lịch sử hàng động nhân viên </h5>
    <?php echo @$mess;?>
    <div id="desktop_view">
