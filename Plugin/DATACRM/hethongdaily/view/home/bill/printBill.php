...
<div class="main">
    ...
    <p class="rs text-center"><em>Thời gian<?php echo date('H:i d/m/Y ', $data->created_at) ?></em></p>
    ...
    <div class="content">
        ...
        <p class="rs p_bao">Họ và tên đạt lý nhận tiền: <?php echo @$data->member->name;?></p>
        <p class="rs p_bao">Địa chỉ: <?php echo @$data->member->address;?></p>
        <p class="rs p_bao">Điện thoại: <?php echo @$data->member->phone;?></p>
        <?php }elseif(!empty($data->customer)){ ?>
            <p class="rs p_bao">Họ và tên người nhận tiền: <?php echo @$data->customer->full_name;?></p>
        <p class="rs p_bao">Địa chỉ: <?php echo @$data->member->address;?></p>
            <p class="rs p_bao">điện thoại: <?php echo @$data->member->phone;?></p>
        ...
        <div class="text-right mt_6">
            <em> <?php echo 'Ngày '.date('d', $data->created_at).' tháng '.date('m', $data->created_at).' năm '.date('Y', $data->created_at)  ?></em>
        </div>
    </div>
