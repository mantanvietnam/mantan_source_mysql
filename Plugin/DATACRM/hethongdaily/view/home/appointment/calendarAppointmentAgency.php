...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card">
    <h5 class="card-header">
      <a href="/listAppointmentAgency" class="btn btn-danger">Xem dạng danh sách</a>
    </h5>
...
<div class="modal fade" id="createBookModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
   ...
   <form class="no-margin" action="/addAppointmentAgency" method="POST">
   ...
   <div class="modal-body">
      ...
      <div class="row">
        ...
        <div class="mb-3 col-md-1">
            ...
            <a href="/editCustomerAgency" class="btn btn-primary" target="_blank" title="Thêm khách hàng mới "><i class='bx bx-plus'></i></a>
        </div>
        <div class="col-md-6 mb-3">
          <label class="form-label">Ngày đặt (*)</label>
          <input type="text" name="time" class="form-control hasDatepicker datetimepicker" id="time" value="">
        </div>
        <div class="col-md-6 mb-3">
          <label class="form-label">Trạng thái</label>
        ...
        <?php
          ...
          if(!empty($listData)){
            foreach($listData as $data){
              ...
              do{
                $apt_times ++;
                $time = $data->time->getTimestamp() + $apt_times*$data->apt_step*24*60*60;
                $id = $data->id;
        ...
        '<div class="modal fade" id="modalinfo">\
          <div class="modal-dialog modal-lg">\
           ...
           if(info.event.extendedProps.statusnote=="1"|| info.event.extendedProps.statusnote=='0'){
             modal += '<button type="button" class="btn btn-primary" onclick="checkin('+info.event.extendedProps.idBook+','+info.event.extendedProps.id_parent+');"><i class="bx bxs-edit"></i> Check in</button>\
