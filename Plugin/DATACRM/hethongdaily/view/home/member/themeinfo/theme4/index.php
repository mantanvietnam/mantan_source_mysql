...
<body>
  <div class="container">
    ...
    <div id="info" class="tab-content active">
        ...
        foreach ($listProduct as $item) {
          ...
          if(!empty($item['product'])){
            foreach ($item['product'] as $product) {
              ...
              <div class="product-old-price">'.number_format($product->price).'đ</div>
              <div class="product-new-price">'.number_format($product->price_old).'đ</div>
              </div>
              <div class="qty-input">
     ...
     /* else{
        echo '<div class="product"><p class="text-danger">Chưa có sản phẩm bán</p> </div>';
      }*/
        ...
        <!-- <div class="input-group input-group-sm mb-3">
          <div class="dropdown">
            <button class="btn btn-outline-secondary dropdown-toggle" type="button" id="dropdownMenuButton"
              data-bs-toggle="dropdown" aria-expanded="false">Nhóm khách hàng</button>
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <li><a class="dropdown-item" href="#" data-value="iCham">iCham</a></li>
              <li><a class="dropdown-item" href="#" data-value="Ezpics">Ezpics</a></li>
            </ul>
          </div>
        </div> -->
                                      ...
                                      <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">';
                                               ...
                                               // echo '<option value="'.$value->id.'">'.$value->name.'</option>';
                                                echo '<li><a class="dropdown-item" href="#" data-value="'.$value->id.'">'.$value->name.'</a></li>';
                                            }
                                echo      '</ul>
                                        </div></div>';
                            }
