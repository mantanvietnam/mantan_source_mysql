...
<head>
    ...
    <link rel="stylesheet" href="/plugins/hethongdaily/view/home/member/themeinfo/theme7/index.css">
...
<body>
            ...
            <div id="info" class="tab-content-item active">
                <section>
                    <div class="block-1">              
                        <div class="block-bgr">
                            <div class="container">
                                <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme7/img/Background.png" alt="">
                                <div class="layout-1">
                                    <div class="profile"> 
                                        <img src="<?php echo $info->avatar;?>" alt="">
                                    </div>
                                </div>
                                <div class="block-txt-pfl"><?php echo $info->name;?></div>
                                <div class="block-cd"><?php echo $info->name_position;?> </div>
                                <div class="home-title"><?php echo $info->name_system;?></div>
                                <div class="hotline">
                                    <p><?php echo $info->phone;?></p>
                                    <button type="button" class="btn btn-save" onclick="saveToPhonebook()"><a href="#">Lưu danh bạ</a></button>
                                </div>
                            </div>
                        </div>
                                ...
                                <ul>
                                    <ul>
                                        ...
                                        <li>
                                            <a target="_blank" href="<?php echo $info->facebook;?>">
                                                <div class="txt-1">
                                                    <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme7/img/facebook.jpg" alt="" style="height: 19px; width: 19px;margin-left: 5px;">
                                    ...
                                    if(!empty($info->zalo)){ ?>
                                        <li>
                                            <a target="_blank" href="<?php echo $info->facebook;?>">
                                                <div class="txt-1">
                                                    <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme7/img/zalo.jpg" alt="" style="height: 19px; width: 19px;margin-left: 5px;">
                                                    <p>Zalo</p>
                                                </div>
                                                <i style="font-size: 16px;" class="fa-solid fa-chevron-right"></i>
                                            </a>
                                    ...
                                    if(!empty($info->tiktok)){ ?>
                                        <li>
                                             <a target="_blank" href="<?php echo $info->tiktok;?>">
                                                <div class="txt-1">
                                                    <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme7/img/tiktok.jpg" alt="" style="height: 19px; width: 19px;margin-left: 5px;">
                                                    <p>TikTok channel</p>
                                                </div>
                                                <i style="font-size: 16px;" class="fa-solid fa-chevron-right"></i>
                                            </a>
                                    ...
                                    if(!empty($info->youtube)){ ?>
                                        <li>
                                            <a target="_blank" href="<?php echo $info->youtube;?>">
                                                <div class="txt-1">
                                                    <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme7/img/youtube.jpg" alt="" style="height: 19px; width: 19px;margin-left: 5px;">
                                    ...
                                    if(!empty($info->web)){ ?>
                                        <li>
                                            <a target="_blank" href="<?php echo $info->web;?>">
                                                <div class="txt-1">
                                                    <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme7/img/internet.jpg" alt="" style="height: 19px; width: 19px;margin-left: 5px;">
                                                    <p>Website công Ty</p>
                                                </div>
                                                <i style="font-size: 16px;" class="fa-solid fa-chevron-right"></i>
                                            </a>
                                    ...
                                    if(!empty($info->instagram)){ ?>
                                       <li>
                                            <a target="_blank" href="<?php echo $info->instagram;?>">
                                                <div class="txt-1">
                                                    <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme7/img/insta.jpg" alt="" style="height: 19px; width: 19px;margin-left: 5px;">
                                                    <p>Instagram</p>
                                                </div>
                                                <i style="font-size: 16px;" class="fa-solid fa-chevron-right"></i>
                                            </a>
                                    ...
                                    if(!empty($info->twitter)){ ?>
                                        <li>
                                            <a target="_blank" href="<?php echo $info->twitter;?>">
                                                <div class="txt-1">
                                                    <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme7/img/twitter.png" alt="" style="height: 19px; width: 19px;margin-left: 5px;">
                                                    <p>Twitter</p>
                                                </div>
                                                <i style="font-size: 16px;" class="fa-solid fa-chevron-right"></i>
                                            </a>
                                    ...
                                    if(!empty($info->linkedin)){ ?> 
                                        <li>
                                             <a target="_blank" href="<?php echo $info->linkedin;?>">
                                                <div class="txt-1">
                                                    <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme7/img/link.jpg" alt="" style="height: 19px; width: 19px;margin-left: 5px;">
                                                    <p>Linkedin</p>
                                                </div>
                                                <i style="font-size: 16px;" class="fa-solid fa-chevron-right"></i>
                                            </a>
                                        ...
                                        <?php if(!empty($dataLink)){
                                            foreach($dataLink as $key => $item){
                                                ...
                                                if($item->type=='website'){
                                                    $icon = ' <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme7/img/internet.jpg" alt="" style="height: 19px; width: 19px;margin-left: 5px;">';
                                                }elseif($item->type=='facebook'){
                                                    $icon = ' <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme7/img/facebook.jpg" alt="" style="height: 19px; width: 19px;margin-left: 5px;">';
                                                }elseif($item->type=='instagram'){
                                                    $icon = ' <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme7/img/insta.jpg" alt="" style="height: 19px; width: 19px;margin-left: 5px;">';
                                                }elseif($item->type=='tiktok'){
                                                    $icon = ' <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme7/img/tiktok.jpg" alt="" style="height: 19px; width: 19px;margin-left: 5px;">';
                                                }elseif($item->type=='youtube'){
                                                    $icon = ' <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme7/img/youtube.jpg" alt="" style="height: 19px; width: 19px;margin-left: 5px;">';
                                                }elseif($item->type=='zalo'){
                                                    $icon = ' <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme7/img/zalo.jpg" alt="" style="height: 19px; width: 19px;margin-left: 5px;">';
                                                }elseif($item->type=='linkedin'){
                                                    $icon = ' <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme7/img/link.jpg" alt="" style="height: 19px; width: 19px;margin-left: 5px;">';
                                                }elseif($item->type=='twitter'){
                                                    $icon = ' <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme7/img/twitter.png" alt="" style="height: 19px; width: 19px;margin-left: 5px;">';
                                                }
            ...
            <div id="products" class="tab-content-item">
                <div class="ladi-wraper">
                    <div id="body-background" class="ladi-section">
                        <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme7/img/Background.png" alt="" style="height: 100%; width:100%; max-height: 100%;background-size: cover;">
                    </div>
                </div>
    ...
    <script src="/plugins/hethongdaily/view/home/member/themeinfo/theme7/index.js"></script>
    <script src="htps://code.jquery.com/jquery-3.3.1.min.js"></script>
