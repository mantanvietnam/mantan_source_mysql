...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@100;300;400;500;700;900&display=swap"
    rel="stylesheet">
  <link
    href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@400;700&family=Playwrite+IT+Moderna:wght@100;400&display=swap"
    rel="stylesheet">
  <link rel="stylesheet" href="/plugins/hethongdaily/view/home/member/themeinfo/theme5/main.css">
  <style>
...
<body>
  <div class="div-container">
    ...
    <div class="home-header">
      ...
      <div class="avt-container">
        <img src="<?php echo $info->avatar;?>" alt="Trần Mạnh" class="img-fluid rounded-circle">
      </div>
      <div>
        ...
        <div class="hotline">
          ...
          <button type="button" class="btn btn-primary btn-save" onclick="saveToPhonebook()">Lưu danh bạ</button>
        </div>
      </div>
      <!--Tabs bar-->
      <div class="tabs">
        <ul class="nav nav-tabs">
          <li class="nav-item"><a class="nav-link active" href="#info">Thông tin</a></li>
        ...
        <div class="home-body-wrapper">
          <div class="home-body">
            ...
            <a href="<?php echo $info->facebook;?>" target="_blank"  class="body-action">
              <div class="logo-container"><img src="/plugins/hethongdaily/view/home/member/themeinfo/theme5/assets/images/fb1.svg" alt=""></div>
            ...
            <a href="<?php echo $info->zalo;?>" target="_blank"  class="body-action">
              <div class="logo-container"><img src="/plugins/hethongdaily/view/home/member/themeinfo/theme5/assets/images/zalo.webp" alt=""></div>
              <div class="action-text">
                <h5>Zalo</h5>
            ...
            <a href="<?php echo $info->tiktok;?>" target="_blank" class="body-action">
              <div class="logo-container"><img src="/plugins/hethongdaily/view/home/member/themeinfo/theme5/assets/images/tiktok.png" alt=""></div>
              <div class="action-text">
                <h5>Tiktok</h5>
            ...
            <a href="<?php echo $info->youtube;?>" target="_blank" class="body-action">
              <div class="logo-container"><img src="/plugins/hethongdaily/view/home/member/themeinfo/theme5/assets/images/youtube.webp" alt=""></div>
              <div class="action-text">
                <h5>Youtube</h5>
            ...
            <a href="<?php echo $info->web;?>" target="_blank" class="body-action">
              <div class="logo-container"><img src="/plugins/hethongdaily/view/home/member/themeinfo/theme5/assets/images/internet.jpg" alt=""></div>
              <div class="action-text">
                <h5>Website</h5>
            ...
            <a href="<?php echo $info->web;?>" target="_blank" class="body-action">
              <div class="logo-container"><img src="/plugins/hethongdaily/view/home/member/themeinfo/theme5/assets/images/instagram.png" alt=""></div>
              <div class="action-text">
                <h5>Instagram</h5>
            ...
            <a href="<?php echo $info->web;?>" target="_blank"  class="body-action">
              <div class="logo-container"><img src="/plugins/hethongdaily/view/home/member/themeinfo/theme5/assets/images/linkedin.webp" alt=""></div>
              <div class="action-text">
                <h5>Linkedin</h5>
             ...
             <?php if(!empty($dataLink)){
              foreach($dataLink as $key => $item){
                ...
                if($item->type=='website'){
                  $icon = '<img src="/plugins/hethongdaily/view/home/member/themeinfo/theme5/assets/images/internet.jpg">';
                }elseif($item->type=='facebook'){
                  $icon = '<img src="/plugins/hethongdaily/view/home/member/themeinfo/theme5/assets/images/fb1.svg">';
                }elseif($item->type=='instagram'){
                  $icon = '<img src="/plugins/hethongdaily/view/home/member/themeinfo/theme5/assets/images/instagram.png">';
                }elseif($item->type=='tiktok'){
                  $icon = '<img src="/plugins/hethongdaily/view/home/member/themeinfo/theme5/assets/images/internet.jpg">';
                }elseif($item->type=='youtube'){
                  $icon = '<img src="/plugins/hethongdaily/view/home/member/themeinfo/theme5/assets/images/youtube.webp">';
                }elseif($item->type=='zalo'){
                  $icon = '<img src="/plugins/hethongdaily/view/home/member/themeinfo/theme5/assets/images/zalo.webp">';
                }elseif($item->type=='linkedin'){
                  $icon = '<img src="/plugins/hethongdaily/view/home/member/themeinfo/theme5/assets/images/linkedin.webp">';
    ...
    <div id="products" class="tab-content">
      ...
      ?>
      <button class="btn btn-primary btn-buy" onclick="checkSelectProduct();">Đặt mua hàng</button>
    </div>
    ...
    <div id="customer" class="tab-content">
      ...
      <form class='form-info' id="customer-form">
        <div class="input-group input-group-sm mb-3">
          <span class="input-group-text" id="name">Họ và tên</span>
          <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="name" required>
        </div>
        <div class="input-group input-group-sm mb-3">
          <span class="input-group-text" id="phone">Số điện thoại</span>
          <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="phone" required>
        </div>
        <div class="input-group input-group-sm mb-3">
        ...
        <div class="input-group input-group-sm mb-3">
          ...
          <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="address" required>
        </div>
        <div class="input-group input-group-sm mb-3">
          <span class="input-group-text" id="birthday">Ngày sinh</span>
        ...
        ?>
        <button class='btn btn-success btn-submit' type='submit'>Lưu thông tin</button>
      </form>
    </div>
  </div>
  ...
  <script src="/plugins/hethongdaily/view/home/member/themeinfo/theme5/profile.js"></script>
  <script>
