...
<head>
  ...
  <link rel="stylesheet" href="/plugins/hethongdaily/view/home/member/themeinfo/theme8/main.css">
...
<body>
  <div class="app-container">
      ...
      <div class="home">
        ...
        <div class="home-header">
          ...
          <div class="home-footer">
            <div class="home-phone">Hotline: <?php echo $info->phone;?></div>
          </div>
        </div>
        <!--Home body-->
        <div class="home-body">
          <button type="button" class="btn-save" onclick="saveToPhonebook()">Lưu danh bạ
          ...
          <div class='container social-container'>
            <div class='row justify-content-center gap-3'>
              ...
              <a href="<?php echo $info->instagram;?>" target="_blank" class="col-4 action-container">
                <div class='logo-container d-flex'>
                  <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme8/assets/images/instagram.png" alt="">
                </div>
                <span>Instagram</span>
              </a>
               <?php }
             if(!empty($info->tiktok)){ ?>
              <a href="<?php echo $info->tiktok;?>" target="_blank" class="col-4 action-container">
                <div class='logo-container'>
                  <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme8/assets/images/tiktok.png" alt="">
                </div>
                <span>Tiktok</span>
              </a>
                <?php }
             if(!empty($info->facebook)){ ?>
              <a href="<?php echo $info->facebook;?>" target="_blank" class="col-4 action-container">
                <div class='logo-container'>
                  <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme8/assets/images/fb.png" alt="">
                </div>
                <span>Facebook</span>
              </a>
                <?php }
             if(!empty($info->zalo)){ ?>
              <a href="<?php echo $info->zalo;?>" target="_blank" class="col-4 action-container">
                <div class='logo-container'>
                  <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme8/assets/images/zalo.jpg" alt="">
                </div>
                <span>zalo</span>
              </a>
                <?php }
             if(!empty($info->web)){ ?>
              <a href="<?php echo $info->web;?>" target="_blank" class="col-4 action-container">
                <div class='logo-container'>
                  <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme8/assets/images/internet.jpg" alt="">
                </div>
                <span>website</span>
              </a>
                <?php }
             if(!empty($info->youtube)){ ?>
              <a href="<?php echo $info->youtube;?>" target="_blank" class="col-4 action-container">
                <div class='logo-container'>
                  <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme8/assets/images/youtube.webp" alt="">
                </div>
                <span>Youtube</span>
              </a>
               <?php }
             if(!empty($info->linkedin)){ ?>
              <a href="<?php echo $info->linkedin;?>" target="_blank" class="col-4 action-container">
                <div class='logo-container'>
                  <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme8/assets/images/link.jpg" alt="">
                </div>
                <span>Linkedin</span>
              </a>
               <?php }
             if(!empty($info->twitter)){ ?>
              <a href="<?php echo $info->twitter;?>" target="_blank" class="col-4 action-container">
                <div class='logo-container'>
                  <img src="/plugins/hethongdaily/view/home/member/themeinfo/theme8/assets/images/twitter.png" alt="">
                </div>
                <span>Twitter</span>
              </a>
               <?php }?>
              ...
              foreach($dataLink as $key => $item){
                ...
                if($item->type=='website'){
                  $icon = '<img src="/plugins/hethongdaily/view/home/member/themeinfo/theme8/assets/images/internet.jpg">';
                }elseif($item->type=='facebook'){
                  $icon = '<img src="/plugins/hethongdaily/view/home/member/themeinfo/theme8/assets/images/fb.png">';
                }elseif($item->type=='instagram'){
                  $icon = '<img src="/plugins/hethongdaily/view/home/member/themeinfo/theme8/assets/images/instagram.png">';
                }elseif($item->type=='tiktok'){
                  $icon = '<img src="/plugins/hethongdaily/view/home/member/themeinfo/theme8/assets/images/tiktok.png">';
                }elseif($item->type=='youtube'){
                  $icon = '<img src="/plugins/hethongdaily/view/home/member/themeinfo/theme8/assets/images/youtube.webp" alt="">';
                }elseif($item->type=='zalo'){
                  $icon = '<img src="/plugins/hethongdaily/view/home/member/themeinfo/theme8/assets/images/zalo.jpg">';
                }elseif($item->type=='linkedin'){
                  $icon = '<img src="/plugins/hethongdaily/view/home/member/themeinfo/theme8/assets/images/link.jpg">';
                }elseif($item->type=='twitter'){
                  $icon = '<img src="/plugins/hethongdaily/view/home/member/themeinfo/theme8/assets/images/twitter.png">';
                }

                echo '<a target="_blank" href="'.$item->link.'" class="col-4 action-container">
            ...
            foreach ($item['product'] as $product) {
              ...
              echo '<div class="product">
                    ...
                    <div class="d-flex flex-column align-items-start gap-1">
                      ...
                      <div class="product-price">'.number_format($product->price).'đ <span class="text-decoration-line-through text-black-50">'.$price_old.'</span></div>
                      <div class="qty-input">
    ...
    <!--Mua hàng-->
    <div class="tab-content mt-4" id="order">
      <div class=" p-3 justify-content-center">
        <div class="form-container">
          <h4>Thông tin đơn hàng</h4>
        <div class="mb-3">
          <label for="full_name" class="form-label text-white">Đối tượng đặt hàng (*)</label><br/>
          <input type="radio" id="typeUser" name="typeUser" value="customer" checked /> <span class="text-white">Khách lẻ</span> 
          &nbsp;&nbsp;&nbsp;
          <input type="radio" id="typeUser" name="typeUser" value="member" /><span class="text-white"> Đại lý </span>
        </div>
          ...
          <div class=" p-4"> 
             ...
             <div class="input-group input-group-sm mb-3">
              <span class="input-group-text" >Ngày sinh</span>
               <input type="date" class="form-control datepicker"  name="birthday" id="birthday" />
            </div>
             <div class="input-group input-group-sm mb-3">
    ...
    <div id="customer" class="tab-content">
      <div class='form-container'>
        ...
        <div class="input-group input-group-sm mb-3">
          <span class="input-group-text" >Ngày sinh</span>
          <input type="date" class="form-control datepicker"  name="birthday" id="datepicker"><br>
        </div>
  ...
  <script src="/plugins/hethongdaily/view/home/member/themeinfo/theme8/profile.js?time=<?php echo time(); ?>"></script>
        ...
        <script type="text/javascript">
             ...
             function checkSelectProduct()
            {
                ...
                if(!checkTick){
                    ...
                    list_cart += '</tbody></table> <p class="text-white"><b>Thành tiền: </b><span id="money">'+formatNumberWithCommas(total_money)+'đ</span</p>';
                    list_cart += '</tbody></table> <p class="text-white"><b>Giảm giá : </b><span id="discountmoney">0%</span</p>';
                    list_cart += '</tbody></table> <p class="text-white"><b>Tổng tiền: </b><span id="total_money">'+formatNumberWithCommas(total_money)+'đ</span</p>';
