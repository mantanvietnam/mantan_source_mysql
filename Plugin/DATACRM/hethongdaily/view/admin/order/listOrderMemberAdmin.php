<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4">Đơn hàng lẻ đại lý</h4>
      ...
      <div class="card-body">
        <div class="row gx-3 gy-2 align-items-center">
          ...
          <div class="col-md-2">
            ...
            <input type="text" class="form-control" name="id_agency" value="<?php if(!empty($_GET['id_agency'])) echo $_GET['id_agency'];?>">
          </div>
        ...
        <tbody>
          ...
          if(!empty($listData)){
            foreach ($listData as $item) {
             ...
             <td width="10%">
              <a href="/plugins/admin/hethongdaily-view-admin-member-listMemberAdmin/?id='.$item->id_agency.'">'.@$item->member->name.'</a><br/>
              '.@$item->member->phone.'
             </td>
