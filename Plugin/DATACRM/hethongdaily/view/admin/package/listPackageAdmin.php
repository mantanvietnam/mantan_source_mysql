<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4">Thông tin gói </h4>
 <p><a href="/plugins/admin/hethongdaily-view-admin-package-addPackageAdmin" class="btn btn-primary"><i class='bx bx-plus'></i> Thêm mới</a></p>
  <!-- Responsive Table -->
  ...
  <div class="card row">
    <h5 class="card-header">Thông tin gói</h5>
      <p><?php echo @$mess;?></p>
          ...
          <?php 
            if(!empty($listData)){
              foreach ($listData as $item) {
                $data = '<span class="text-danger">Ẩn</span>';
                if($item->status == 'active'){
                  $status = '<span class="text-success">Hiểu thị</span> ';
                }
                echo '<tr>
                        <td>'.$item->id.'</td>
                        <td>'.@$item->name.'</td>
                        ...
                        <td>'.@$status.'</td>
                         <td align="center">
                          <a class="dropdown-item" href="/plugins/admin/hethongdaily-view-admin-package-addPackageAdmin/?id='.$item->id.'">
                            <i class="bx bx-edit-alt me-1"></i>
                          </a>
                        </td>
                        <td align="center">
                          <a class="dropdown-item" onclick="return confirm(\'Bạn có chắc chắn muốn xóa không?\');" href="/plugins/admin/hethongdaily-view-admin-package-deletePackageAdmin/?id='.$item->id.'">
