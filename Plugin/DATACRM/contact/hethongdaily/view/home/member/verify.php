...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="/plugins/hethongdaily/view/home/assets/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
  ...
  <body>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  <span class="app-brand-text demo text-body fw-bolder">XÁC THỰC TÀI KHOẢN</span>
                </a>
              </div>
              <!-- /Logo -->
              ...
              <form id="formAuthentication" class="mb-3" action="" method="POST">
                ...
                <div class="mb-3">
                  <label for="phone" class="form-label">Mã xác thực gửi về Zalo</label>
                  <?php echo $mess;?>
                  <input type="text" class="form-control" id="otp" name="otp" placeholder="" autofocus />
                  
                  <a href="javascript:void(0);" onclick="resendOTP();">
                      <small>Gửi lại mã xác thực</small>
                  </a>
                </div>
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" type="submit">Xác thực</button>
                </div>
              </form>
            </div>
          </div>
    ...
    <script src="/plugins/hethongdaily/view/home/assets/vendor/libs/jquery/jquery.js"></script>
    <script src="/plugins/hethongdaily/view/home/assets/vendor/libs/popper/popper.js"></script>
    <script src="/plugins/hethongdaily/view/home/assets/vendor/js/bootstrap.js"></script>
    ...
    <script type="text/javascript">
      function resendOTP()
      {
          var idMember = '<?php echo $infoUser->id;?>';
