...
$sqlUpdateDatabase['campaign_customers']['id_staff'] = "ALTER TABLE `campaign_customers` ADD  `id_staff` INT NULL DEFAULT NULL; ";
$sqlUpdateDatabase['campaign_customers']['number_call'] = "ALTER TABLE `campaign_customers` ADD  `number_call` INT NOT NULL DEFAULT '0'; ";
$sqlUpdateDatabase['campaign_customers']['status'] = "ALTER TABLE `campaign_customers` ADD `status` VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT 'new';";
