<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4"> <span class="text-muted fw-light"><a href="/plugins/admin/product-view-admin-product-listProduct">Sản phẩm</a></span> / video đập hộp</h4>
            ...
            if(!empty($listData)){
              foreach ($listData as $item) {
                ...
                echo '<tr>
                        ...
                        <td align="center">
                          <a class="dropdown-item" onclick="return confirm(\'Bạn có chắc chắn muốn xóa không?\');" href="/plugins/admin/product-view-admin-product-deleteReview/?id='.$item->id.'">
    ...
    <div class="modal fade" id="basicModal<?php echo $item->id; ?>"  name="id">
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                             ...
                             <form action="/plugins/admin/product-view-admin-product-upReview" method="GET">
