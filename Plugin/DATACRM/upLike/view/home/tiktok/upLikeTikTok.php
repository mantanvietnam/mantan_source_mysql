...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <!-- Responsive Table -->
  <div class="card row">
    <h5 class="card-header">Tăng like Tiktok</h5>
    <?php echo $mess;?>
       ...
       <div class="modal-footer">
        <div class="card-body">
          <div class="row gx-3 gy-2 align-items-center">
            <div class="col-md-12">
              <label class="form-label">Link/uid  link bài viết Tiktok</label>
            ...
            <div class="col-md-12">
              ...
              <select name="chanel" id="chanel" class="form-select color-dropdown" required onchange="selectChanel();">
                ...
                <?php
                  ...
                  if(!empty($listPrice['data']['tiktok']['buff']['like'])){
                    foreach ($listPrice['data']['tiktok']['buff']['like'] as $key => $value) {
                      $price = ceil($value['rate'])*$multiplier;
                      echo '<option data-price="'.$price.'" value="'.$key.'" title="'.$value['detail'].'">Kênh '.$key.' giá '.$price.'đ/lượt like</option>';
                    }
                  }
                ?>
              </select>
