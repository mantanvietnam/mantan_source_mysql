...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4">Tăng lượng xem video Facebook</h4>
  <p>
  ...
  <!-- Responsive Table -->
  <div class="card row">
    <h5 class="card-header">Tăng lượng xem video Facebook</h5>
    <?php echo $mess;?>
       ...
       <div class="modal-footer">
        <div class="card-body">
          <div class="row gx-3 gy-2 align-items-center">
            <div class="col-md-12">
              <label class="form-label">Link/uid  video Facebook</label>
            ...
            <div class="col-md-12">
              ...
              <select name="chanel" id="chanel" class="form-select color-dropdown" required onchange="selectChanel();">
                ...
                <?php
                  if(!empty($listPrice['data']['facebook']['buff']['view'])){
                    foreach ($listPrice['data']['facebook']['buff']['view'] as $key => $value) {
  ...
  function checkUID() 
  {
    ...
    if(uid != ''){
      $.ajax({
        method: "POST",
        url: "/apis/getUidAPI",
        data: { uid: uid, type: 'post_id' ,type_prority: 'reel' }
      })
        .done(function( msg ) {
