...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4">Tăng lượt xem story Facebook</h4>
  <p>
  ...
  <!-- Responsive Table -->
  <div class="card row">
    <h5 class="card-header">Tăng lượt xem story Facebook</h5>
    <?php echo $mess;?>
       ...
       <div class="modal-footer">
        <div class="card-body">
          <div class="row gx-3 gy-2 align-items-center">
            <div class="col-md-12">
              <label class="form-label">Link/uid  link story Facebook</label>
            ...
            <div class="col-md-12">
              ...
              <select name="chanel" id="chanel" class="form-select color-dropdown" required onchange="selectChanel();">
                ...
                <?php
                  if(!empty($listPrice['data']['facebook']['buff']['viewstory'])){
                    foreach ($listPrice['data']['facebook']['buff']['viewstory'] as $key => $value) {
                      $price = ceil($value['rate'])*$multiplier;
                      echo '<option data-price="'.$price.'" value="'.$key.'" title="'.$value['detail'].'">Kênh '.$key.' giá '.$price.'đ/lượt xem</option>';
                    }
                  }
                ?>
              </select>
