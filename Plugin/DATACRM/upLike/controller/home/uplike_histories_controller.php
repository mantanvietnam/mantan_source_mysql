...
function upViewVideoFacebook($input)
{
    global $controller;
    global $urlCurrent;
    global $modelCategories;
    ...
    $user = checklogin('upViewVideoFacebook');   
    if(!empty($user)){
        if(empty($user->grant_permission)){
            return $controller->redirect('/statisticAgency');
        }
...
function upFriendFacebook($input)
{
    global $controller;
    global $urlCurrent;
    global $modelCategories;
    ...
    $user = checklogin('upFriendFacebook');   
    if(!empty($user)){
        if(empty($user->grant_permission)){
            return $controller->redirect('/statisticAgency');
        }
...
function upViewStoryFacebook($input)
{
    global $controller;
    global $urlCurrent;
    global $modelCategories;
    ...
    $user = checklogin('upViewStoryFacebook');   
    if(!empty($user)){
        if(empty($user->grant_permission)){
            return $controller->redirect('/statisticAgency');
        }
        ...
        $user = $modelMembers->get($user->id);
        $type_api = 'facebook.buff.viewstory';
...
function upShareFacebook($input)
{
    global $controller;
    global $urlCurrent;
    global $modelCategories;
