                                    ...
                                    echo '<tr>
                                            ...
                                            <td align="center">
                                              <a class="btn btn-primary" 
                                                href="/plugins/admin/go_draw-view-admin-agency_order_product-addAgencyOrderProductAdmin/?id='.$item->id .'"
                                              >
                                            ...
                                            <td align="center">
                                              <a class="btn btn-danger" onclick="return confirm(\'Bạn có chắc chắn muốn xóa không?\');" 
                                                href="href=/plugins/admin/go_draw-view-admin-agency_order_product-deleteAgencyOrderProductAdmin/?id='.$item->id.'"
                                              >
