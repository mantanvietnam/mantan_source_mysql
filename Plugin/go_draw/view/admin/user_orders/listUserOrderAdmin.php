...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">Đơn bán hàng của đại lý</h4>
        ...
        <div class="col-xl">
            <div class="card mb-6">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Danh sách đơn bán hàng của đại lý (Tổng tiền: <?php echo number_format($total_money);?>đ)</h5>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <th class="col-md-3">Người dùng</th>
                                <th class="col-md-3">Gói sản phẩm</th>
