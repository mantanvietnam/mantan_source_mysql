        ...
        <div class="container">
            <div class="content-detail-gallery detail-cart">
                <div class="title text-center" style="display: flex;">
                    <span>Yêu cầu mua hàng chưa thanh toán</span>
                            ...
                            echo '  <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                              ...
                                              <th scope="col" width="150">Thời gian tạo</th>
                                            </tr>
                                        </thead>
                                        <tbody>';
                                        ...
                                        if(!empty($listData)){
                                            foreach ($listData as $key => $value) {
                                                $status = '';
                                                if($value->status == 1){
                                                    $status = '<br/><a href="/addProductToStore/?id='.$value->id.'" type="button" class="btn btn-danger">Nhập kho</a>';
                                                }
                                                ...
                                                echo      '</td>
                                                          ...
                                                          <td>'.date_format($value->created_at, "H:i:s d/m/Y").$status.'</td>
                                                        </tr>';
                                            }
                                        }
