						...
						<div class="col-md-6">
							...
							<div class="title-detail">
								<div class="content-head-title">
									...
									<div class="price"><?php echo number_format($agency_combo->price);?>đ</div>
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="txt-detail-gallery">
								<div class="detail">
									...
									<div class="social text-right">
										<div class="btn-main">
											<a id="orderButton" href="/addToCartComboUser/?idAgencyCombo=<?php echo $agency_combo->id;?>&amount=1">ĐẶT MUA</a>
										</div>
									</div>
								</div>
							</div>
...
<script type="text/javascript">
	function updateAmount()
	{
		...
		var idCombo = '<?php echo $agency_combo->id;?>';

		$('#orderButton').attr('href', '/addToCartComboUser/?idAgencyCombo='+idCombo+'&amount='+amount)
	}
</script>
