							...
							<div class="txt-detail-gallery">
								<div class="detail">
									...
									<div class="social text-right">
										<div class="btn-main">
											<a id="orderButton" href="/addCartComboUser/?idCombo=<?php echo $infoCombo->id;?>&amount=1">ĐẶT MUA</a>
										</div>
									</div>
								</div>
							</div>
...
<script type="text/javascript">
	function updateAmount()
	{
		...
		$('#orderButton').attr('href', '/addCartComboUser/?idCombo='+idCombo+'&amount='+amount)
	}
</script>
