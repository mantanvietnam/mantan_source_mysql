						...
						<div class="info-form-user">
							<form enctype="multipart/form-data" method="post" action="">
								...
								<div class="item-frm">
									...
									<div class="desc">
										<input type="text" placeholder="Tên cửa hàng" name="name" class="txt_filed" value="<?php echo @$user->name;?>">
									</div>
								</div>
								<div class="item-frm">
									<div class="icon">
									...
									<div class="desc">
										<input type="text" placeholder="Địa chỉ" name="address" class="txt_filed" value="<?php echo @$user->address;?>">
									</div>
								</div>
								<div class="item-frm">
									<div class="icon">
									...
									<div class="desc">
										<input type="text" placeholder="Điện thoại" name="phone" class="txt_filed" value="<?php echo @$user->phone;?>">
									</div>
								</div>
