...
$sqlInstallDatabase .= "CREATE TABLE `teachers` ( `id` INT NOT NULL AUTO_INCREMENT , `name` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , `position` INT NOT NULL , `introduce` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , `avatar` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;";
