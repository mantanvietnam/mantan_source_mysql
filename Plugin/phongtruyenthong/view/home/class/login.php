...
>
  <head>
    ...
    <title>Đăng nhập Phòng truyền thống ảo</title>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="/plugins/phongtruyenthong/view/home/assets/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
  ...
  <body>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Chuyên Lào Cai</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Phòng truyền thống ảo 👋</h4>
              <p class="mb-4">Đăng nhập trang quản trị thông tin lớp học</p>
              <?php echo @$mess;?>
    ...
    <script src="/plugins/phongtruyenthong/view/home/assets/vendor/libs/popper/popper.js"></script>
    ...
    <script src="/plugins/phongtruyenthong/view/home/assets/vendor/js/menu.js"></script>
    <!-- endbuild -->

    <!-- Vendors JS -->

    <!-- Main JS -->
    <script src="/plugins/phongtruyenthong/view/home/assets/js/main.js"></script>
