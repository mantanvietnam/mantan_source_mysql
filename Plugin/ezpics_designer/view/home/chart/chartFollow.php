...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4">Thống kê lượng theo dõi</h4>
...
<div class="taovien" >
    ...
    <script type="text/javascript">
        ...
        function drawChartOrder() {
            var data = google.visualization.arrayToDataTable([
              ['Ngày', 'Số lượng theo dõi'],
              <?php 
              // for($i=1;$i<32;$i++){
                    if(!empty(@$dayDataFollow) ){
                        foreach($dayDataFollow as $date=>$number){
    ...
    <div id="order_chart" style="width: 100%; height: 540px; background: white; padding: 20px"></div>
</div>
</center> 
