              ...
              if(!empty($listData)){
                ...
                if($item->status==1){
                  ...
                  echo '<tr>
                          ...
                          <td align="center">
                            <a class="dropdown-item" onclick="return confirm(\'Bạn có chắc chắn muốn xóa không?\');" href="/plugins/admin/ezpics_designer-view-admin-member-deleteMemberAdmin/?id='.$item->id.'">
