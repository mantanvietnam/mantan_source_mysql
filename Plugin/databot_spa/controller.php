<?php 
// admin
include_once('controller/admin/membersController.php'); // admin
include_once('controller/admin/adminController.php'); // admin

// home
include_once('controller/home/membersController.php'); // người dùng
...
include_once('controller/api/debtController.php'); // đối tác
