                 ...
                 <div class="side-bar">
                         <div class="box-form-bar">
                                ...
                                <div class="action-cta">
                                    ...
                                    <ul>
                                        <li><a href="/buyPrepayCard" class="btn  btn-secondary">Nhập lại</a></li>
...
function addProduct(id, name, priceProduct, price){
    ...
    if(listProductAdd.hasOwnProperty(id)){
        ...
        $('#listProductOrder tr:first').after('<tr id="tr'+row+'"><td style="text-align: initial;"><input type="hidden" name="idHangHoa['+row+']" id="idProduct'+row+'" value="'+id+'"><input type="hidden" name="priceCard['+row+']" id="priceCard'+row+'" value="'+price+'">'+name+'</td><td><div class="quantity"><div class="number-spinner"><span class="ns-btn" ></span><input name="soluong['+row+']" min="1" id="soluong'+row+'"  type="number" class="pl-ns-value form-control" value="1"  onchange="tinhtien();"></div></div></td><td><input type="text"  value="'+priceProduct+'" class="input_money form-control" name="money['+row+']" min="1" id="money-'+row+'" onchange="tinhtien();"></td><td id="totalmoney'+row+'"></td><td><a href="javascript:void(0);" class="dropdown-item" onclick="deleteProduct(\''+row+'\')"><i class="bx bx-trash me-1" aria-hidden="true"></i></a></td></tr>');    
            $("#trFirst").hide();
