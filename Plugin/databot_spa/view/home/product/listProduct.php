...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <p><a href="/addProduct" class="btn btn-primary"><i class='bx bx-plus'></i> Thêm mới</a> <a href="/addProductWarehouse" class="btn btn-danger"><i class='bx bx-plus'></i>Nhập hàng vào kho </a></p>
  <?php echo $mess;?>
  
  <!-- Form Search -->
  <form method="get" action="">
    <div class="card mb-4">
      <h5 class="card-header">Tìm kiếm sản phẩm</h5>
      <div class="card-body">
