...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <!-- Responsive Table -->
  <div class="card">
    <h5 class="card-header">Danh sách công nợ phải thu  - <b class="text-danger"><?php echo number_format($total);?>đ</b></h5>
    <?php echo @$mess; ?>
                             ...
                             <form action="paymentCollectionBill" method="GET">
                               <div class="modal-footer">
                                ...
                                <div class="card-body">
                                  <div class="row gx-3 gy-2 align-items-center">
                                    <div class="col-md-12">
                                      <p><label class="form-label">Tên người nợ:</label> <?php echo $items->full_name ?></p>
