...
class NL_Checkout 
{
	...
	// Nếu bạn thay đổi mật khẩu giaoán trên NgânLượng.vn, vui lòng update lại mật khẩu này trên website của bạno tiếp trong quản trị website của chức năng tích hợp thanh t
