...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light"><a href="/plugins/admin/tayho360-admin-hotel-listHotelAdmin"> khách sạn</a> /</span>
    <?php 
     if(!empty($_GET['id'])){
        echo "Sửa thông tin";
             ...
             <div class="row" >
                ...
                <div class="col-md-12">
                    <ul class="nav nav-tabs" role="tablist">
                              ...
                              <li class="nav-item">
                                <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#tab6" aria-controls="navs-top-image" aria-selected="false">
                                 Tiện nghi dịch vụ 
                                </button>
                              </li>                       
                    </ul>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active show" id="tab1" role="tabpanel">
                                <div class="row" >
                                    ...
                                    <div class="mb-3 form-group col-sm-2">
                                        <i>Giá nghỉ giờ:</i>
