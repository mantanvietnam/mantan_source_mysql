...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light"><a href="/plugins/admin/tayho360-admin-eventcenter-listEventcenterAdmin.php">Trung tâm hội nghị sự kiện</a> /</span>
    <?php 
     if(!empty($_GET['id'])){
        echo "Sửa thông tin";
      ...
      <div class="col-xl">
        <div class="card mb-12">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Thông tin trung tâm hội nghị sự kiện</h5>
          </div>
          <div class="card-body">
            <p><?php echo @$mess;
        ?></p>
                ...
                <ul class="nav nav-tabs" role="tablist">
                          <li class="nav-item">
                            <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#tab1" aria-controls="navs-top-home" aria-selected="true">
                              Thông tin trung tâm hội nghị sự kiện
                            </button>
                          </li>
                          <li class="nav-item">
