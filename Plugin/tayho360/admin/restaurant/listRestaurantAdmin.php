            ...
            if(!empty($listData)){
              foreach ($listData as $item) {
                echo '<tr>
                        ...
                        <td align="center">
                          <a class="dropdown-item" href="tayho360-admin-restaurant-addRestaurantAdmin.php/?id='.$item->id.'">
                            <i class="bx bx-edit-alt me-1"></i>
                          </a>
                        </td>
                        <td align="center">
                          <a class="dropdown-item" onclick="return confirm(\'Bạn có chắc chắn muốn xóa không?\');" href="/plugins/admin/tayho360-admin-restaurant-deleteRestaurantAdmin.php/?id='.$item->id.'">
