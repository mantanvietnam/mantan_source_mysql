...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light"><a href="/plugins/admin/tayho360-admin-festival-listFestivalAdmin.php">Lễ hội</a> /</span>
    <?php 
     if(!empty($_GET['id'])){
        echo "Sửa thông tin";
      ...
      <div class="col-xl">
        <div class="card mb-12">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Thông tin lễ hội</h5>
          </div>
          <div class="card-body">
            <p><?php echo @$mess;
        ?></p>
            ...
            <div class="mb-3 form-group col-sm-6">
             ...
             <div class="mb-3 form-group col-sm-6">
                ...
                <input type="text" maxlength="100" name="holdtime" id="holdtime" value="<?php echo @$data['holdtime'] ?>" class="form-control" required="">
            </div>
            <div class="mb-3 form-group col-sm-6">
               <i>Ảnh đại diện*:</i>
                <br>
