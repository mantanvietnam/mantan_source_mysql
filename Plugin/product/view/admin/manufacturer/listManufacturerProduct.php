...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">Nhà sản xuất</h4>
                      ...
                      <?php 
                        if(!empty($listData)){
                          foreach ($listData as $item) {
                            echo '<tr>
                                    <td><a target="_blank" href="/manufacturer/'.$item->slug.'.html">'.$item->name.'</a></td>
                                    <td align="center">
                          ...
                          echo '<tr>
                                  <td colspan="3" align="center">Chưa có nhà sản xuất</td>
                                </tr>';
                        }
                      ?>
          ...
          <div class="card mb-6">
            ...
            <div class="card-body">
              <?= $this->Form->create(); ?>
                ...
                <div class="mb-3">
                  <label class="form-label" for="basic-default-phone">Tên nhà sản xuất</label>
                  <input
                    type="text"
