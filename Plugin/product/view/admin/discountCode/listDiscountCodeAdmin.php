<div class="container-xxl flex-grow-1 container-p-y">
 ...
 <p><a href="/plugins/admin/product-view-admin-discountCode-addDiscountCodeAdmin.php" class="btn btn-primary"><i class='bx bx-plus'></i> Thêm mới</a></p>
  <!-- Responsive Table -->
            ...
            if(!empty($listData)){
              foreach ($listData as $item) {
                ...
                echo '<tr>
                        ...
                        <td>'.@$item->note.'</td>
                         <td align="center">
                          <a class="dropdown-item" href="/plugins/admin/product-view-admin-discountCode-addDiscountCodeAdmin.php/?id='.$item->id.'">
                            <i class="bx bx-edit-alt me-1"></i>
                          </a>
                        </td>
                        <td align="center">
                          <a class="dropdown-item" onclick="return confirm(\'Bạn có chắc chắn muốn xóa không?\');" href="/plugins/admin/product-view-admin-discountCode-deleteDiscountCodeAdmin.php/?id='.$item->id.'">
