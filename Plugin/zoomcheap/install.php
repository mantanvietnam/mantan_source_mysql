...
$sqlInstallDatabase .= "CREATE TABLE `zooms` ( `id` INT NOT NULL AUTO_INCREMENT , `user` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , `pass` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , `key_host` VARCHAR(255) NOT NULL , `type` INT NOT NULL , `status` VARCHAR(255) NOT NULL , `idOrder` INT(11) NULL DEFAULT '0' , `modified` INT NOT NULL , `created` INT NOT NULL , `client_id` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , `client_secret` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , `account_id` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , `deadline` INT NOT NULL DEFAULT '0' , `link` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB; ";
