...
$sqlInstallDatabase .= "CREATE TABLE `managers` ( `id` INT NOT NULL AUTO_INCREMENT , `fullname` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , `phone` VARCHAR(12) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , `email` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , `password` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , `coin` INT NOT NULL , `modified` INT NOT NULL , `created` INT NOT NULL , `lastLogin` INT NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB; ";
