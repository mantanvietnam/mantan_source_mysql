        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <h4 class="mb-2">Zoom Cheap! 👋</h4>
              <p class="mb-4">Mời bạn đăng ký tài khoản mới</p>
              <?php echo @$mess;?>
              <form id="formAuthentication" class="mb-3" action="" method="POST" enctype="multipart/form-data" onsubmit="functions.submitForgot(); return false;">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" required class="form-control" id="fullname" name="fullname" placeholder="" autofocus />
                </div>
                <div class="mb-3">
