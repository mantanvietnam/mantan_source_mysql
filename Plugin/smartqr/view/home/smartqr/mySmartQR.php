...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4">Smart QR</h4>
  ...
  <!-- Responsive Table -->
  <div class="card row">
    <h5 class="card-header">Danh sách mã Smart QR</h5>
            ...
            if(!empty($listData)){
              foreach ($listData as $item) {
                echo '<tr>
                        ...
                        <td><a href="/staticMyQR/?id='.$item->id.'">'.number_format($item->number_scan).'</a></td>
                        <td>'.$item->status.'</td>
                        <td align="center">
                          <a class="dropdown-item" href="/editMyQR/?id='.$item->id.'">
