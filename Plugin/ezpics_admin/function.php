...
$menus[0]['sub'][3]= array('title'=>'Giao dịch',
                            ...
                            'sub'=> array(array('title'=>'Nạp tiền',
                                            ...
                                            array('title'=>'Bán kho mẫu thiết kế',
                                                'url'=>'/plugins/admin/ezpics_admin-view-admin-transaction-listTransactionHistorySellingWarehouseEzpics.php',
                                                'classIcon'=>'bx bx-history',
                                                'permission'=>'listTransactionHistorySellingWarehouseEzpics',
                                            ),
                                            array('title'=>'Mua kho mẫu thiết kế',
                                                'url'=>'/plugins/admin/ezpics_admin-view-admin-transaction-listTransactionHistoryBuyWarehouseEzpics.php',
                                                'classIcon'=>'bx bx-history',
                                            ...
                                            array('title'=>'Nâng cấp Pro',
                                                'url'=>'/plugins/admin/ezpics_admin-view-admin-transaction-listTransactionProEzpics.php',
                                                'classIcon'=>'bx bx-history',
...
$menus[0]['sub'][8]= array( 'title'=>'Thống kê',
                            ...
                            'permission'=>'homeAdmin',
                             'sub'=> array(array('title'=>'Thống kê nhanh',
                                                'url'=>'/plugins/admin/ezpics_admin-view-admin-chart-statisticalAdmin.php',
                                                'classIcon'=>'bx bx-category',
                                        ...
                                        array('title'=>'Thống kê đăng nhập',
                                                'url'=>'/plugins/admin/ezpics_admin-view-admin-chart-chartUserLastloginAdmin.php',
                                                'classIcon'=>'bx bx-category',
                                                'permission'=>'listfontAdmin',
                                            ),
                                        array('title'=>'Thống kê lượng mua mẫu thiết kế',
                                                'url'=>'/plugins/admin/ezpics_admin-view-admin-chart-chartOrberProductAdmin.php',
                                                'classIcon'=>'bx bx-category',
                                                'permission'=>'listfontAdmin',
                                            ),
                                    )
