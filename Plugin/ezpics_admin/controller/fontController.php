    ...
    if ($isRequestPost) {
        ...
        if(!empty($dataSend['name'])){
            ...
            $mess= '<p class="text-success">Lưu dữ liệu thành công</p>';
             ...
             if(!empty($_GET['id'])){
                return $controller->redirect('/plugins/admin/tayho360-admin-font-listFontAdmin.php?status=2');
            }else{
              
                return $controller->redirect('/plugins/admin/tayho360-admin-font-listFontAdmin.php?status=1');
            }
...
function deleteFontAdmin($input){
    ...
    return $controller->redirect('/plugins/admin/tayho360-admin-font-listFontAdmin.php?status=3');
}
 ?>