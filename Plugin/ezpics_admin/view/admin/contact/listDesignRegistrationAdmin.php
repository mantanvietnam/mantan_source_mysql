              ...
              if(!empty($listData)){
                ...
                if($item->status==1){
                  ...
                  echo '<tr>
                          ...
                          <td align="center">
                            <a class="dropdown-item"  href="/plugins/admin/ezpics_admin-view-admin-contact-addDesignRegistrationAdmin/?id='.$item->id.'">
                              <i class="bx bx-show"></i>
                            </a>
                          </td>
                          <td align="center">
                            <a class="dropdown-item" onclick="return confirm(\'Bạn có chắc chắn muốn xóa không?\');" href="/plugins/admin/ezpics_admin-view-admin-contact-deleteDesignRegistrationAdmin/?id='.$item->id.'">
        ...
        if(!empty($listData)){
          ...
          foreach ($listData as $item) {
            ...
            echo '<div class="col-sm-12 p-2 m-2 border border-secondary mb-3">
                    ...
                    <p><img src="'.@$Member->avatar.'" width="100" height="80" ></p>
                    <p>'.@$Member->email.'</p>
                    <p>'.@$Member->phone.'</p>

                    <p><b>Đăng ký lúc:</b> '.$item->created_at.'</p>
                    <p><b>Trạng thái:</b> '.$status.'</p>

                    <p class="text-center">
                      <a class="btn btn-success"  href="/plugins/admin/ezpics_admin-view-admin-contact-addDesignRegistrationAdmin/?id='.$item->id.'">
                        <i class="bx bx-show"></i> Xử lý
                      </a>
                      &nbsp;&nbsp;&nbsp;&nbsp;
                      <a class="btn btn-danger" onclick="return confirm(\'Bạn có chắc chắn muốn xóa không?\');" href="/plugins/admin/ezpics_admin-view-admin-contact-deleteDesignRegistrationAdmin/?id='.$item->id.'">
