...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <div class="row gx-3 gy-2 align-items-center">
          ...
          <div class="col-md-2">
            <label class="form-label">ID Mẫu thiết kế</label>
  ...
  <div class="card row">
    <div class="row">
      <div class="col-md-6">
        <h5 class="card-header">Giao dịch bán mẫu thiết kế - <b class="text-danger"><?php echo number_format(@$totalData);?></b> giao dịch</h5>
      </div>
      <div class="col-md-6">
