            ...
            <div class="card-body">
              <?= $this->Form->create(); ?>
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="" name="meta_keyword" id="keyword" value="" />
                </div>

                <div class="mb-3">
                  <label class="form-label" for="basic-default-fullname">Mô tả</label>
                  <input type="text" class="form-control" placeholder="" name="meta_description" id="description" value="" />
                </div>
