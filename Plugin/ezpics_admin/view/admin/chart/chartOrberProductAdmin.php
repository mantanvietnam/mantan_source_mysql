<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4">Thống kê số mẫu thiết ké đã mua</h4>
    ...
    <script type="text/javascript">
        ...
        function drawChartOrder() {
            var data = google.visualization.arrayToDataTable([
              ['Ngày', 'số mẫu thiết ké đã mua'],
              <?php 
              // for($i=1;$i<32;$i++){
                    if(!empty(@$dayDataOrder) ){
                        foreach($dayDataOrder as $date=>$number){
