<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4">Thống kê lịch sử nâng cấp Pro</h4>
    ...
    <script type="text/javascript">
        ...
        function drawChartUser() {
            var data = google.visualization.arrayToDataTable([
              ['Ngày', 'Số tài khoản nâng cấp Pro'],
              <?php 
              // for($i=1;$i<32;$i++){
     ...
     <h5 class="card-header">Tổng người nâng cấp Pro trong tháng <?php echo @$total ?></h5>
