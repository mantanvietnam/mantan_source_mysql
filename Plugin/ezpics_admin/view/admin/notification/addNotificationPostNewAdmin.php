...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light"><a href="/plugins/admin/ezpics_admin-view-admin-notification-addNotificationAdmin.php">Thông báo tin tức mới</a> /</span>
    Tạo thông báo
  </h4>
      ...
      <div class="col-xl">
        <div class="card mb-12">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Tạo thông báo tin tức mới</h5>
          </div>
          <div class="card-body">
            <p><?php echo @$mess;?></p>
            <?= $this->Form->create(); ?>
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="mb-3">
                    <label class="form-label" for="basic-default-phone">Id tin tức (*)</label>
