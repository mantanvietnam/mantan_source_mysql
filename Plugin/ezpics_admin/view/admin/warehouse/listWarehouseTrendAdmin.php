...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4">Kho mẫu thiết kế lên xu hướng</h4>
   <p><a  data-bs-toggle="modal" data-bs-target="#basicModal" style=" color: white; " class="btn btn-primary"><i class='bx bx-plus'></i> Thêm kho mẫu thiết kế</a></p>
  <!-- Form Search -->
  ...
  <!-- Responsive Table -->
  <div class="card row">
    <h5 class="card-header">Danh sách kho mẫu thiết kế lên xu hướng - <b class="text-danger"><?php echo number_format(@$totalData);?></b> mẫu</h5>
    <p><?php echo @$mess;?></p>
    <div id="desktop_view">
