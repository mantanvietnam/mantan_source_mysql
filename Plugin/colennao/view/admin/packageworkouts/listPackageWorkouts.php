<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4">Gói bài luyện tập </h4>
 
  <p><a href="/plugins/admin/colennao-view-admin-packageworkouts-addPackageWorkouts" class="btn btn-primary"><i class='bx bx-plus'></i>Thêm mới</a></p> 
  ...
  <!-- Responsive Table -->
  <div class="card row">
    <h5 class="card-header">Danh sách gói bài luyện tập  </h5>
        ...
        if (!empty($listData)) {
            foreach ($listData as $item) {
              ...
              echo '<tr>
                 ...
                 href="/plugins/admin/colennao-view-admin-packageworkouts-addPackageWorkouts/?id=' . $item->id . '"
                 >
                 <i class="bx bx-edit-alt me-1" style="font-size: 22px;"></i>
                 </a>
                 </p>
                 <p align="center">
                 <a class="btn btn-success" href="/plugins/admin/colennao-view-admin-packageworkouts-addWorkout/?id=' . $item->id . '">
