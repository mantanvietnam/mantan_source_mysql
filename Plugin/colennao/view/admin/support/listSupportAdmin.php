            ...
            <table class="table table-bordered">
                ...
                if (!empty($listData)) {
                  ...
                  <a class="btn btn-success"
                    ...
                    href="/plugins/admin/excgo-view-admin-complaint-updateStatusSupportAdmin.php/?id=' . $item->id . '&status=0"
                  >
                  ...
                  <a class=" btn btn-danger" 
                    ...
                    href="/plugins/admin/excgo-view-admin-complaint-updateStatusSupportAdmin.php/?id=' . $item->id . '&status=1"
                  >
