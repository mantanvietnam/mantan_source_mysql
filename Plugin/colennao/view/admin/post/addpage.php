            ...
            <div class="row">
              <div class="col-12 col-sm-12 col-md-6">
                <div class="mb-3 col-12 col-sm-12 col-md-12">
                  ...
                  <input type="text" class="form-control" name="title" value="<?php echo @$infoPost->title;?>" required placeholder="Tiêu đề  tiếng Việt "/>
                </div>
                <div class="mb-3 col-12 col-sm-12 col-md-12">
                  <label class="form-label">Tiêu đề  tiếng Anh *</label>
                  <input type="text" class="form-control" name="title_en" value="<?php echo @$infoPost->title_en;?>" required placeholder="Tiêu đề  tiếng Anh"/>
                </div>
              ...
              <div class="col-12 col-sm-12 col-md-6">
                ...
                <div class="mb-3 col-12 col-sm-12 col-md-12">
                  ...
                  <textarea class="form-control" name="description" required rows="3" placeholder="Mô tả ngắn tiếng Vệt"><?php echo @$infoPost->description;?></textarea>
                </div>
                <div class="mb-3 col-12 col-sm-12 col-md-12">
                  <label class="form-label" for="basic-default-message">Mô tả ngắn *</label>
                  <textarea class="form-control" name="description_en" required rows="3" placeholder="Mô tả ngắn tiếng Anh"><?php echo @$infoPost->description_en;?></textarea>
                </div>
              ...
              <div class="col-12 col-sm-12 col-md-12">
                <div class="mb-3">
                  <label class="form-label" for="basic-default-message">Nội dung bải viết tiếng Việt</label>
                  <?php showEditorInput('content', 'content', @$infoPost->content);?>
                </div>
                <div class="mb-3">
                  <label class="form-label" for="basic-default-message">Nội dung bải viết tiếng Anh</label>
                  <?php showEditorInput('content_en', 'content_en', @$infoPost->content_en);?>
                </div>
              </div>
            </div>
