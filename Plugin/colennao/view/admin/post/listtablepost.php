<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <p><a href="/plugins/admin/colennao-view-admin-post-addtablepost" class="btn btn-primary"><i class='bx bx-plus'></i> Thêm mới</a></p>
        ...
        <tbody>
            <?php foreach ($listData as $item): ?>
                <tr>
                    ...
                    <td align="center">
                        <a class="dropdown-item" onclick="return confirm('Bạn có chắc chắn muốn xóa không?');" href="/plugins/admin/colennao-view-admin-post-deletepost/?id=<?php echo urlencode($item->id); ?>">
