<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4">Thách thức </h4>
 
  <p><a href="/plugins/admin/colennao-view-admin-challenge-addChallenge" class="btn btn-primary"><i class='bx bx-plus'></i>Thêm mới</a></p> 
        ...
        if (!empty($listData)) {
            foreach ($listData as $item) {
              ...
              echo '<tr>
                 ...
                 href="/plugins/admin/colennao-view-admin-challenge-addChallenge/?id=' . $item->id . '"
                 >
