        ...
        <tbody>
            <?php foreach ($listData as $item): ?>
                <tr>
                    ...
                    <td align="center">
                        <a class="dropdown-item" href="/plugins/admin/colennao-view-admin-categorydiet-addcategorydiet/?id=<?php echo urlencode($item->id); ?>">
                            <i class="bx bx-edit-alt me-1"></i>
                        </a>
                    </td>
                    <td align="center">
                        <a class="dropdown-item" onclick="return confirm('Bạn có chắc chắn muốn xóa không?');" href="/plugins/admin/colennao-view-admin-categorydiet-deletecategorydiet/?id=<?php echo urlencode($item->id); ?>">
