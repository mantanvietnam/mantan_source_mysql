...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">Danh sách bộ môn</h4>
          ...
          <div class="card mb-6">
            ...
            <div class="card-body">
              <?= $this->Form->create(); ?>
                ...
                <div class="mb-3">
                  <label class="form-label" for="basic-default-phone">Tên bộ môn</label>
    ...
    function deleteCategory(id){
      ...
      if(check){
        $.ajax({
          ...
          .done(function( msg ) {
            window.location = '/plugins/admin/colennao-view-admin-questions-categorytypeexercise';
          })
          .fail(function() {
            window.location = '/plugins/admin/colennao-view-admin-questions-categorytypeexercise';
          });
