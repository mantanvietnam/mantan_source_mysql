...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">Khu vực</h4>
                    ...
                    <tbody class="table-border-bottom-0">
                      <?php 
                        if(!empty($listData)){
                          ...
                          echo '<tr>
                                  <td colspan="3" align="center">Chưa có Khu vực</td>
                                </tr>';
                        }
                      ?>
    ...
    function deleteCategory(id){
      ...
      if(check){
        $.ajax({
          ...
          .done(function( msg ) {
            window.location = '/plugins/admin/key_person-view-admin-person-categoryPersonAdmin';
          })
          .fail(function() {
            window.location = '/plugins/admin/key_person-view-admin-person-categoryPersonAdmin';
          });
