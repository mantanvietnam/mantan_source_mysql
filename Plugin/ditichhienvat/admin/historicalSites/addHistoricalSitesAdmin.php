...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light"><a href="/plugins/admin/ditichhienvat-admin-historicalSites-listHistoricalSitesAdmin"> Điểm đến Di tích</a> /</span>
    <?php 
     if(!empty($_GET['id'])){
        echo "Sửa thông tin";
      ...
      <div class="col-xl">
        <div class="card mb-12">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Thông tin điểm đến di tích</h5>
          </div>
          <div class="card-body">
            <p><?php echo $mess;
        ?></p>
        ...
        <div class="col-md-12">
            ...
            <a class="btn btn-danger" href="/plugins/admin/ditichhienvat-admin-historicalSites-listHistoricalSitesAdmin">Hủy</a> 
        </div>
          </div>
            <?= $this->Form->end() ?>
          </div>
