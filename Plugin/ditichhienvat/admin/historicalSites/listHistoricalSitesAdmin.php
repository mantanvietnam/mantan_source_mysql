<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card row">
    <h5 class="card-header">Danh sách Thông tin điểm đến Di tích</h5>
      <p><?php echo @$mess;?></p>
            ...
            if(!empty($listData)){
              foreach ($listData as $item) {
                echo '<tr>
                        ...
                        <td align="center">
                          <a class="dropdown-item" href="ditichhienvat-admin-historicalSites-addHistoricalSitesAdmin/?id='.$item->id.'">
                            <i class="bx bx-edit-alt me-1"></i>
                          </a>
                        </td>
                        <td align="center">
                          <a class="dropdown-item" onclick="return confirm(\'Bạn có chắc chắn muốn xóa không?\');" href="/plugins/admin/ditichhienvat-admin-historicalSites-deleteHistoricalSitesAdmin/?id='.$item->id.'">
