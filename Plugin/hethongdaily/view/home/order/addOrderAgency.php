                            ...
                            <div class="info-bh">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <span><input class="per-bh input_money form-control" min="0" onchange="tinhtien();" type="text" name="promotion" id="promotion" placeholder="0" value="<?php echo (int) @$position->description;?>" autocomplete="off" readonly /></span>
                                    </li>
