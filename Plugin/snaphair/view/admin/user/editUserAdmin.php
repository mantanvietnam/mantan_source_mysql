...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light"><a href="/plugins/admin/snaphair-view-admin-user-listUserAdmin">Thành viên</a> /</span>
            ...
            <div class="card mb-12">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3 ">
                            <label class="form-label">giớ tính</label>
                            <div class="input-group input-group-merge">
                        ...
                        <div class="col-md-6 mb-3">
                         ...
                         <div class="col-md-6 mb-3 ">
                            ...
                            <input  type="text" class="form-control datepicker" name="birthday" id="birthday" value="<?php echo date('d/m/Y',@$data->birthday);?>" />
                        </div>
                  </div>
