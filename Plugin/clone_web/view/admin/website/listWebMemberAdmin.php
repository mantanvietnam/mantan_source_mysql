<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <p><a href="/plugins/admin/clone_web-view-admin-website-addWebMemberAdmin" class="btn btn-primary"><i class='bx bx-plus'></i> Thêm mới</a></p>
        ...
        <tbody>
          ...
          if(!empty($listData)){
            foreach ($listData as $item) {
              ...
              <td align="center">
                <a class="dropdown-item" href="/plugins/admin/clone_web-view-admin-website-addWebMemberAdmin/?id='.$item->id.'">
                  <i class="bx bx-edit-alt me-1" style="font-size: 22px;"></i>
                </a>
              </td>

              <td align="center">
                <a class="dropdown-item" onclick="return confirm(\'Bạn có chắc chắn muốn xóa không?\');" href="/plugins/admin/clone_web-view-admin-website-deleteWebMemberAdmin/?id='.$item->id.'">
