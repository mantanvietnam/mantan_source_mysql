...
class InstallsController extends AppController{
	...
	public function createDatabase(){
		...
		$sql .= "CREATE TABLE `posts` ( `id` INT NOT NULL AUTO_INCREMENT , `title` TEXT CHARACTER SET utf8 COLLATE utf8_vietnamese_ci NOT NULL , `keyword` TEXT CHARACTER SET utf8 COLLATE utf8_vietnamese_ci NOT NULL , `slug` TEXT CHARACTER SET utf8 COLLATE utf8_vietnamese_ci NOT NULL , `pin` BOOLEAN NOT NULL , `time` INT NOT NULL , `author` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_vietnamese_ci NOT NULL , `image` TEXT CHARACTER SET utf8 COLLATE utf8_vietnamese_ci NOT NULL , `idCategory` INT NOT NULL , `description` TEXT CHARACTER SET utf8 COLLATE utf8_vietnamese_ci NOT NULL , `content` TEXT CHARACTER SET utf8 COLLATE utf8_vietnamese_ci NOT NULL , `view` INT NOT NULL DEFAULT '0' , PRIMARY KEY (`id`)) ENGINE = InnoDB; ";
