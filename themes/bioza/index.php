...
?>
    ...
    <section id="about" style="background-image: url(<?php echo @$setting['background_2'];?>);">
        <div class="container">
            <div class="row">
                <div class="about-title">

                    <h2><span><?php echo @$setting['full_name'];?></span> là ai?</h2>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12 col">
                            <div class="about-detail first">
                                <div class="content">
                                    <h2>Họ và tên</h2>
                                    <p><?php echo @$setting['full_name'];?></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12 col">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="services-box">
                        <div class="services-icon">
                            <i class="<?php echo @$setting['icon1'];?>"></i>
                        </div>
                        <div class="services-detail">
                            <h2>
                                <?php echo @$setting['service1'];?>
                            </h2>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="services-box">
                        <div class="services-icon">
                            <i class="<?php echo @$setting['icon2'];?>"></i>
                        </div>
                        <div class="services-detail">
                            <h2>
                                <?php echo @$setting['service2'];?>
                            </h2>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="services-box">
                        <div class="services-icon">
                            <i class="<?php echo @$setting['icon3'];?>"></i>
                        </div>
                        <div class="services-detail">
                            <h2>
                                <?php echo @$setting['service3'];?>
                            </h2>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="services-box">
                        <div class="services-icon">
                            <i class="<?php echo @$setting['icon4'];?>"></i>
                        </div>
                        <div class="services-detail">
                            <h2>
                                <?php echo @$setting['service4'];?>
                            </h2>
                            <p><?php echo @$setting['content_service4'];?></p>
                        </div>
                        <div class="services-btn">
                            <!-- <a href="">
                                Read more
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="services-box">
                        <div class="services-icon">
                            <i class="<?php echo @$setting['icon5'];?>"></i>
                        </div>
                        <div class="services-detail">
                            <h2>
                                <?php echo @$setting['service5'];?>
                            </h2>
                            <p><?php echo @$setting['content_service5'];?></p>
                        </div>
                        <div class="services-btn">
                            <!-- <a href="">
                                Read more
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="services-box">
                        <div class="services-icon">
                            <i class="<?php echo @$setting['icon6'];?>"></i>
                        </div>
                        <div class="services-detail">
                            <h2>
                                <?php echo @$setting['service6'];?>
                            </h2>
                            <p><?php echo @$setting['content_service6'];?></p>
                        </div>
                        <div class="services-btn">
                            <!-- <a href="">
                                Read more
    ...
    <section id="brand" style="background-image: url(<?php echo @$setting['background_3'];?>);">
        <div class="container">
            <div class="row">
    ...
    <section id="testimonial" style="background-image: url(<?php echo @$setting['background_4'];?>);">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="testimonial-content">
                        <div class="testimonial-detail">
                            ...
                            <h3><?php echo @$setting['textred'];?></h3>
                            <p><?php echo @$setting['textwhite'];?></p>
                        </div>
