                ...
                <div class="place-around-slide">
                    ...
                    <div class="place-around-slide-item">
                        <div class="place-around-img">
                            <a href="/chi_tiet_dich_vu_ho_tro_du_lich/<?php echo $value->urlSlug ?>.html"><img src="<?php echo $value->image ?>" alt=""></a>
                        </div>


                        <div class="place-around-title">
                            <a href="/chi_tiet_dich_vu_ho_tro_du_lich/<?php echo $value->urlSlug ?>.html"><?php echo $value->name ?></a>
                        </div>
...
<?php } ?>
<?php  $comment= getComment($data->id,'dich_vu_ho_tro_du_lich'); 
        if(!empty($comment)){ ?>
