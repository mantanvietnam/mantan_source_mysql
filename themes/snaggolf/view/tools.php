...
<main>
    <section class="post-head">
        <img src="<?php echo $urlThemeActive; ?>assets/img/tool-header.png" alt="">
    </section>
    <section class="head-component">
        <div class="container">
            ...
            <p class="tool_page">
                Kích thích tình yêu golf trong trẻ nhỏ ngay hôm nay với bộ gậy sắc màu từ SNAG USA
            </p>
        </div>
    </section>
    <section class="page-all-tool">
        <div class="container">
            <div class="row g-4 g-xl-5" loop="4">
                <div class="col-12 col-lg-4">
                    <div class="card-tool-custom">
                        <div class="head">
                            <img class="" src="<?php echo $urlThemeActive; ?>assets/img/card-tool.png" alt="">
                    ...
                    <div class="row g-3" loop="6">
                        <div class="col-12 col-lg-6 mt-0 mb-2">
                            <div class="form-field">
                                ...
                                <input required type="text" class="form-control" placeholder="Example: Nguyen Vu Minh Long">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-4" loop="3">
                    <div class="col-12 col-lg-4">
                        <div class="card-news">
                            <div class="card">
                                <div class="head-card">
                                    <img src="<?php echo $urlThemeActive; ?>assets/img/card-news.png" class="card-img-top" alt="...">
                                    <div class="overlay">
                                        <span>20/08/2022</span>
                                        <a href=""><button class="rounded-circle"><img src="<?php echo $urlThemeActive; ?>assets/img/greater-than.svg" alt=""></button></a>
                                    </div>
                                </div>
                                <a href="">
                                    <div class="card-body">
