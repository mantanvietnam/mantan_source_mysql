        ...
        <header class="py-4 mx-4 bg-transparent sm:mx-6 lg:mx-20 font-plus">
          <div class="flex items-center justify-between font-bold">
            ...
            >
              ...
              <a
                href="/contact"
                class="px-4 py-2 text-white transition-all duration-300 ease-in-out bg-transparent border border-white shadow-md rounded-xl hover:bg-white hover:text-blue-700 hover:shadow-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
              >
                Liên hệ tư vấn
              </a>
            </div>
