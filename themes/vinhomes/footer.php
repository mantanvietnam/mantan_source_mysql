        ...
        <div class="flex flex-col justify-between md:flex-row">
          <div class="mb-8 md:mb-0">
            <h2 class="flex items-center mb-4 text-lg font-bold">
              <img
                src="<?= $urlThemeActive ?>image/icons/iconLogo.png"
                alt="icon"
                class="h-8 mr-4"
              />
              MinhTuanVinhomes
            ...
            <div class="flex mb-4 space-x-4">
              ...
              /></a>
              <a href="#"><img src="<?= $urlThemeActive ?>image/icons/youtube.svg" alt="icon" /></a>
            </div>
            <address class="mb-4 space-y-2 not-italic">
              <p>123 Main Street, Hometown, USA</p>
              <p>0789373568</p>
              <p>minhtuanvinhomes@gmail.comp</p>
            </address>
          ...
          <div class="mb-8 md:mb-0">
            ...
            <div class="flex mb-4 space-x-4">
              <a href="<?php echo @$setting['instagram']; ?>" target="_blank"
                ><img src="./image/icons/instagram.svg" alt="icon"
              /></a>
              <a href="<?php echo @$setting['facebook']; ?>" target="_blank"
                ><img src="./image/icons/facebook.svg" alt="icon"
              /></a>
              <a href="<?php echo @$setting['linkedin']; ?>" target="_blank"
                ><img src="./image/icons/linkedin.svg" alt="icon"
              /></a>
              <a href="<?php echo @$setting['youtube']; ?>" target="_blank"
              ><img src="./image/icons/youtube.svg" alt="icon" /></a>
            </div>
            <address class="mb-4 space-y-2 not-italic">
