...
?>
    <main class="bg-pt py-4">
        <section class="section-heading lien-he-heading">
            <h3 class="text-uppercase text-center my-5">Đăng ký</h3>
        </section>
                                ...
                                <form id="formContact" action="" method="post" class="form-custom-1 py-3">
                                    ...
                                    <div class="card h-100">
                                        <div class="card-body p-lg-5">
                                            <h3 CLASS="fs-2 mb-5">Đăng ký tài khoản</h3>
                                            <div class="row g-3">
                                                <?php echo $mess;?>
                                                <div class="col-12 col-md-6">
                                                    <label class="mb-2">Họ tên</label>
                                                    <input name="full_name" type="text" class="form-control" placeholder="" required>
                                                </div>
                                                <div class="col-12 col-md-6">
