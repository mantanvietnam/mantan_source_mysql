        ...
        <section id="all-news-section">
            <div class="container">
                ...
                <div class="all-news-list">
                    <div class="row">
                    <?php foreach ($listdataevent as $key => $value) { ?>
                        <div class="col-lg-4 col-md-6">
                            <div class="all-news-item">
                                <a href="/detailevent/<?php echo @$value->slug ?>.html">
                                    <div class="all-news-img">
                                        <img src="<?php echo $value->banner;?>" alt="">
                                    </div>
                                    <div class="all-news-content">
                                        <div class="home-news-thum">
                                            <p><?php echo $value->address;?></p>
                                            <span><?php echo date('d/m/Y', $value->time_start);?></span>
                                        </div>
