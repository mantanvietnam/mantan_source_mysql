                    ...
                    <form method="POST" action="">
                        ...
                        <input type="hidden" value="<?php echo @$data->id_member; ?>" name="id_member">
                            <div class="mb-3">
                                ...
                                <input style="background-color:red" type="hidden" name="name" class="form-control" id="name" placeholder="Tên" value="<?php echo @$data->name;?>" readonly>
                            </div>

                            <div class="mb-3">
                            
                                <input style="background-color:red" type="hidden" name="email" class="form-control" id="email" placeholder="email" value="<?php echo @$data->email;?>" readonly>
                            </div>
                            <div class="mb-3">
                          
                                <input style="background-color:red" type="hidden" name="sex" class="form-control" id="sex" placeholder="Giới tính" value="<?php echo @$data->sex;?>" readonly>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input style="background-color:red" type="hidden" name="city" class="form-control" id="city" placeholder="city" value="<?php echo @$data->city;?>" readonly>
                            </div>
                        <div class="mb-3">
