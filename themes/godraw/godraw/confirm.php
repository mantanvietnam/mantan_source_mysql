						...
						<div class="info-form-user">
							<form enctype="multipart/form-data" method="post" action="">
								...
								<div class="item-frm">
									...
									<div class="desc">
										<input type="text" required placeholder="Mã xác thực gửi về email" name="otp" class="txt_filed">
									</div>
								</div>
								...
								<div class="item-frm">
									...
									<div class="desc">
										<input type="text" placeholder="Mật khẩu mới" name="pass" class="txt_filed">
									</div>
								</div>
