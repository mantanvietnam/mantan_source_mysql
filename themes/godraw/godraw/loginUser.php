						...
						<div class="info-form-user">
							<form enctype="multipart/form-data" method="post" action="">
								...
								<div class="item-frm">
									...
									<div class="desc">
										<input type="text" placeholder="Tài khoản" name="username" class="txt_filed">
									</div>
								</div>
								<div class="item-frm">
									<div class="icon">
									...
									<div class="desc">
										<input type="password" placeholder="Mật khẩu" name="password" class="txt_filed">
									</div>
								</div>
								...
								<div class="item-frm justify-content-center">
									<div class="item-submit">
										<input type="submit" value="ĐĂNG NHẬP" class="btn_filed">
									</div>
								</div>
							</form>
						</div>
