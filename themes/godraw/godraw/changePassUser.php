							...
							<div class="item-frm">
								<div class="icon">
									<svg width="36" height="35" viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M18.0713 34.6401C8.53129 34.6401 0.78125 26.8801 0.78125 17.3501C0.78125 7.8201 8.54129 0.0600586 18.0713 0.0600586C27.6113 0.0600586 35.3613 7.8201 35.3613 17.3501C35.3613 26.8801 27.6013 34.6401 18.0713 34.6401ZM18.0713 1.58984C9.38129 1.58984 2.31128 8.6601 2.31128 17.3501C2.31128 26.0401 9.38129 33.1099 18.0713 33.1099C26.7613 33.1099 33.8313 26.0401 33.8313 17.3501C33.8213 8.6601 26.7513 1.58984 18.0713 1.58984Z" fill="white"/>
										<path d="M28.542 30.27C25.652 27.7 21.942 26.29 18.072 26.29C14.202 26.29 10.4921 27.7 7.60205 30.27L6.58203 29.1201C9.75203 26.3001 13.832 24.75 18.072 24.75C22.312 24.75 26.392 26.3001 29.562 29.1201L28.542 30.27Z" fill="white"/>
										<path d="M18.072 19.2202C14.542 19.2202 11.6719 16.3498 11.6719 12.8198C11.6719 9.28982 14.542 6.41992 18.072 6.41992C21.602 6.41992 24.4719 9.28982 24.4719 12.8198C24.4619 16.3498 21.592 19.2202 18.072 19.2202ZM18.072 7.95996C15.392 7.95996 13.2119 10.1398 13.2119 12.8198C13.2119 15.4998 15.392 17.6802 18.072 17.6802C20.752 17.6802 22.9319 15.4998 22.9319 12.8198C22.9319 10.1398 20.752 7.95996 18.072 7.95996Z" fill="white"/>
									</svg>
								</div>
								<div class="desc">
									<span><?php echo $session->read('infoMember')->name;?></span>
								</div>
							</div>
							<div class="item-frm">
								<div class="icon">
								...
								<div class="desc">
									<span class="txt-desc"><?php echo number_format($session->read('infoMember')->total_coin)?> COIN</span>
								</div>
							</div>
