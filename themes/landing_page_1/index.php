            ...
            <div class="row">
                <div class="col-lg-6 form-left">
                    <div class="form-content mt-3">
                        ...
                        <form action="/contact" id="myForm" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="_csrfToken" value="<?php echo $csrfToken;?>">
                            <input type="hidden" name="subject" value="Đăng ký học">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 input-contact">
                                    ...
                                    <textarea class="form-control" name="content" id="" placeholder="" required></textarea>
                                </div>
