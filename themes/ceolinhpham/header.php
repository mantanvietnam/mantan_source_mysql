	...
	<body>
		...
		<header>
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
			  	<div class="container">
			  		<a class="navbar-brand slogan_page" href="/">
			  			<!-- <p><?php echo @$setting['titleNav']; ?></p><small><?php echo @$setting['sloganNav']; ?></small> -->
			  			<img src="<?php echo @$setting['logo']; ?>" style=" width: 50px; ">
			  		</a>
