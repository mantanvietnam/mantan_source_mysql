        ...
        <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
          <div class="card mb-4">
            ...
            <div class="card-body row ">
                ...
                <div class="mb-3 col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 form-label">Khối dịch vụ</h5>
                  </div>
                </div>
                 <div class="mb-3 col-12 col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                ...
                <div class="mb-3 col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 form-label">Khối thứ 4</h5>
                  </div>
                </div>
                <div class="mb-3 col-12 col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                ...
                <div class="mb-3 col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 form-label">Khối thư viện</h5>
                  </div>
                </div>
                <div class="mb-3 col-12 col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                ...
                <div class="mb-3 col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 form-label">Khối thống kê</h5>
                  </div>
                </div>
                 <div class="mb-3 col-12 col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                  <label class="form-label" for="basic-default-fullname">ảnh nền </label>
                ...
                <div class="mb-3 col-12 col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                 ...
                 <div class="mb-3 col-12 col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                  ...
                  <input type="text" class="form-control" name="statistics3" value="<?php echo @$data['statistics2'];?>" />
                ...
                <div class="mb-3 col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 form-label">Khối mạng xã hội</h5>
                  </div>
                </div>
                <div class="mb-3 col-12 col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
