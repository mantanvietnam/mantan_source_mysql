...
<head>
    ...
    <link rel="stylesheet" href="<?= $urlThemeActive?>/asset/css/header.css?time=00000">
    <link rel="stylesheet" href="<?= $urlThemeActive?>/asset/css/main-plus.css?time=10000">
    <link rel="stylesheet" href="<?= $urlThemeActive?>/asset/css/main-hoang.css?time=2230101">
    <!-- Slick Carousel CSS -->
