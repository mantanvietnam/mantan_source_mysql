                ...
                <div class="col-9 tab-intro-left">
                    <div class="mg-24">
                        <div class="title-main-home">
                            <h3 class="text-uppcase text-title-main-home">Kế toán thuế</h3>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <a href="" class="link-news">
                                        <img src="<?php echo $urlThemeActive;?>/asset/image/images1920558_4053279_16.jpg" alt="">
                                        <div class="author">
                                            <span>Đăng bởi:</span>
                                            <span class="name-author">Thư Phạm</span>
                                        </div>
                                        <p class="title-news">Hội thảo cập nhật chính sách thuế tháng 08/2023</p>
                                        <p class="description-news">Hội thảo cập nhật chính sách Thuế là sự kiện được lắng nghe, vấn đáp
                    ...
                    <div class="mg-24">
                        <div class="title-main-home">
                            <h3 class="text-uppcase text-title-main-home">kế toán tổng hợp</h3>
                            <div class="border-title-main-home"></div>
                    ...
                    <div class="mg-24">
                        <div class="title-main-home">
                            <h3 class="text-uppcase text-title-main-home">nghề nghiệp - việc làm</h3>
                            <div class="border-title-main-home"></div>
                    ...
                    <div class="mg-24">
                        <div class="title-main-home">
                            <h3 class="text-uppcase text-title-main-home">Chế độ kế toán</h3>
                            <div class="border-title-main-home"></div>
