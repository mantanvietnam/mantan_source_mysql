            ...
            <div class="row">
                <div class="col-11 mg-auto">
                    ...
                    <div class="intro-my-service">
                        <div class="row">
                            <div class="col-3 backgroud-intro-my-service relative" style="background-image: url(<?php echo $urlThemeActive; ?>/asset/image/Asset14.png) ;">
                                <div class="setting-icon">
                                    <img src="<?php echo $urlThemeActive; ?>/asset/image/Asset9.png" alt="">
                                </div>
                            ...
                            <div class="col-3 backgroud-intro-my-service relative" style="background-image: url(<?php echo $urlThemeActive; ?>/asset/image/Asset13.png) ;">
                                <div class="text-my-service">
            ...
            <div class="row">
                <div class="col-11 mg-auto">
                    ...
                    <div class="icon-why-my-service text-center">
                        <div class="row justify-center">
                            <div class="col-3 text-center">
                                <div class="img-why-my">
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="91.88px" height="94.98px" viewBox="0 0 91.88 94.98" style="enable-background:new 0 0 91.88 94.98;" xml:space="preserve">
                                        <style type="text/css">
                                            .st0 {
                                                fill: #00C0EB;
                                            }
                            ...
                            <div class="col-3 text-center">
                                <div class="img-why-my">
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100.12px" height="109.3px" viewBox="0 0 100.12 109.3" style="enable-background:new 0 0 100.12 109.3;" xml:space="preserve">
                                        <style type="text/css">
                                            .st0 {
                                                fill: #00C0EB;
                                            }
                            ...
                            <div class="col-3 text-center">
                                <div class="img-why-my">
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="83.2px" height="81.3px" viewBox="0 0 83.2 81.3" style="enable-background:new 0 0 83.2 81.3;" xml:space="preserve">
                                        <style type="text/css">
                                            .st0 {
                                                fill: #00C0EB;
                                            }
                        ...
                        <button class="button-why-my"><a class="font-san-bold" href="/contact">Nhận tư vấn miễn phí <span>
                ...
                <div class="col-11">
                    <div class="row">
                        <div class="col-7 text-center">
                            ...
                            <p class="dcreption-banner-dang-ki">Đăng kí ngay để nhận bản tin của chúng tôi sớm nhất và nhanh nhất</p>
                        </div>
