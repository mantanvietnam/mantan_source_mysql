			...
			<div class="col-12 col-sm-12 col-md-12 col-lg-6">
				...
				<div class="wr-info-product">
					<div class="nav nav-tabs " role="tablist">
						<a id="tab-info1" href="#tab-info" class="active" data-toggle="tab" role="tab" >Thông tin</a>
						<a id="tab-uses1" href="#tab-uses" class="" data-toggle="tab" role="tab" >Công dụng</a>
					</div>
					<div class="tab-content" role="tablist">
						
						<div id="tab-info" class="tab-pane fade show active" role="tabpanel" aria-labelledby="tab-info1">
		...
		<div class="main-carousel main-carousel-related" data-flickity='{"imagesLoaded": true, "cellAlign": "left", "contain": true, "pageDots": false, "prevNextButtons": false }'>
			<?php if(!empty($other_product)){
				...
				<div class="carousel-cell carousel-cell-related">
					<a href="<?php echo @$urlHomes.'product/'.$value['slug'].'.html' ?>">
						<div class="box-bd-product">
							<img src="<?php echo @$value['image'] ?>" alt="">
						</div>
		  				<center><?php echo @$value['title'] ?></center>
		  				<center class="price"><?php echo @number_format($value['price']); ?> VNĐ</center>
					</a>
	  				<center class="add-cart" ><button data-sku = 'MÃ SP' class="add-cart-button" onclick="addProductCart('<?php echo @$value['id'] ?>', 'true')">Thêm vào giỏ hàng <span class="messAdd">Đã thêm vào giỏ</span></button></center>
				</div>
				<?php
				}
			}
