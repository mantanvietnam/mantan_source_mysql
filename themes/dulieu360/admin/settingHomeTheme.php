    ...
    <?= $this->Form->create(); ?>
      <div class="row">
        ...
        <div class="col-12 col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
          <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
              <h5 class="mb-0 form-label">Welcome</h5>
            </div>
            <div class="card-body">
                <div class="mb-3">
        ...
        <div class="col-12 col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
          <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
              <h5 class="mb-0 form-label">PROFILE HÌNH ẢNH</h5>
            </div>
            <div class="card-body">
                <div class="mb-3">
                  <label class="form-label" for="basic-default-fullname">PROFILE</label>
                  <?php showUploadFile('profile','profile', @$setting['profile'],10);?>
                </div>
                 <div class="mb-3">
                  <label class="form-label" for="basic-default-fullname"> HÌNH ẢNH</label>
                  <?php showUploadFile('imge_profile','imge_profile', @$setting['imge_profile'],11);?>
                </div>
                <button type="submit" class="btn btn-primary">Lưu</button>
            </div>
          </div>
            ...
            <div class="card-body">
                <div class="mb-3">
                  <label class="form-label" for="basic-default-fullname">Giới thiệu</label>
                   <?php
                                    showEditorInput('content','content',@$setting['content'],1);
                                ?> 
                </div>
