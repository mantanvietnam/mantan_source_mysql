    ...
    <main>
        <section id="page-banner-img">
            <div class="banner-img">
                <img src="<?php echo $urlThemeActive ?>img/hinh-anh-ho-tay.jpg" alt="">
            </div>
        </section>
        <section class="section-background-index">
            <div class="container-fluid background-index">
                <img src="<?php echo $urlThemeActive ?>img/background-index.jpg" alt="">
            </div>
        </section>
        ...
        <section id="section-img-360">
            <div class="container-img-360 container">
                <div class="row">
                    <?php foreach ($listData as $img): ?>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 item-img-360">
                            <div class="img-360">
                                <a href="<?= $img->image360 ?>"><img target="_blank" src="<?= $img->image ?>"
                                                                     alt="<?= $img->name ?>"></a>
                            </div>
                        </div>
                    <?php endforeach; ?>
