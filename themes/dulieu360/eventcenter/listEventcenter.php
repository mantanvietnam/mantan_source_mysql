    ...
    <main>
        ...
        <section id="place-category">
            <div class="category-title">
                ...
                <p>Hãy khám phá những điểm đến trung tâm hội nghị sự kiện ở Đống Đa</p>
            </div>
                ...
                <div class="row place-category-box">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12 place-category-item">
                        <div class="place-category-item-img">
                            ...
                            <a href="/chi_tiet_trung_tam_hoi_nghi_su_kien/<?php echo $item->urlSlug ?>.html"><img src="<?php echo $item->image ?>" alt=""></a>
                            <div class="place-category-item-title">
                                <a href="/chi_tiet_trung_tam_hoi_nghi_su_kien/<?php echo $item->urlSlug ?>.html"><?php echo $item->name ?></a>
                            </div>
                        </div>
                    </div>
                <?php }} ?>
