...
<main class="container mt-3 mt-lg-5">
    <div class="row g-4" id="main-post">
        <div class="col-lg-8">
            ...
            <article class="blog-post">
                <h1 class="blog-post-title text-primary-custom"><?php echo $post->title;?></h1>
                <!-- Content bài viết -->
                <div class="content-here"><?php echo $post->content;?></div>
            </article>
        </div>
    ...
    <div class="row mb-2">
        <section class="chuong-trinh-dao-tao more-news">
            <div class="container">
                <h2 class="text-center text-secondary-custom">Bài viết khác</h2>
