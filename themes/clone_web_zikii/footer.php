        ...
        <secrion id="section-footer">
            <div class="container">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="footer-item">
                            <div class="footer-title">
                                <h3><?php echo @$settingThemes['title_footer_left'] ?></h3>
                            </div>

                            <div class="footer-subtitle">
                                <p><?php echo @$settingThemes['title_footer_green'] ?></p>
                            </div>

                            <div class="footer-list">
                                <ul>
                                    <li>Địa chỉ: <strong><?php echo @$settingThemes['address_footer'] ?></strong></li>
                                    <li>Điện thoại: <strong><?php echo @$settingThemes['phone_footer'] ?></strong></li>
                                    <li>Email: <a href="mailto:<?php echo @$settingThemes['email_footer'] ?>"><?php echo @$settingThemes['email_footer'] ?></a></li>
                                    <li>Website: <a href=""><?php echo @$settingThemes['web_footer'] ?></a></li>
                                    <li>Fanpage Facebook: <a href="<?php echo @$settingThemes['link_page'] ?>"><?php echo @$settingThemes['page_footer'] ?></a></li>
                                </ul>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-12">
                        <div class="footer-item">
                            <div class="footer-menu-title">
                                <h3><?php echo @$settingThemes['title_footer_right'] ?></h3>
                            </div>
                            ...
                            <div class="social-list">
                                <ul class="d-flex">
                                    <li class="social-item">
                                        <a target="_blank" href="<?php echo @$settingThemes['link_page'] ?>">
                                            <img src="<?php echo $urlThemeActive ?>asset/image/face.png" alt="">
                                        </a>
                                    </li>

                                    <li class="social-item">
                                        <a target="_blank" href="<?php echo @$settingThemes['insta'] ?>">
                                            <img src="<?php echo $urlThemeActive ?>asset/image/logozalo.png" alt="">
                                        </a>
                                    </li>

                                    <li class="social-item">
                                        <a target="_blank" href="<?php echo @$settingThemes['youtube'] ?>">
                                            <img src="<?php echo $urlThemeActive ?>asset/image/youtube.png" alt="">
                                        </a>
                                    </li>

                                    <li class="social-item">
                                        <a target="_blank" href="<?php echo @$settingThemes['tiktok'] ?>">
                ...
                <div class="section-footer-info">
                    <div class="container">
                        <p><?php echo @$settingThemes['business_certificates'] ?></p>
                        <p>Người đại diện theo pháp luật: <?php echo @$settingThemes['represent'] ?></p>
                        <p>Email: <?php echo @$settingThemes['email_footer'] ?>, Điện thoại: <?php echo @$settingThemes['phone_footer'] ?></p>
                    </div>
                </div>
            </div>
        </secrion>
        <section id="section-footer-bottom">
            <p><?php echo @$settingThemes['textfooter'] ?></p>
        </section>
