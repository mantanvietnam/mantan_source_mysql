! function(t, n) {
    ...
    function l(t, n, r) {
        return (l = "undefined" != typeof Reflect & amp; & amp; Reflect.get ? Reflect.get : function(t, n, r) {
            var e = function(t, n) {
                for (; !Object.prototype.hasOwnProperty.call(t, n) & amp; & amp; null !== (t = i(t)););
                return t
            }(t, n);
            if (e) {
    ...
    function d() {
        var t = arguments.length & gt;
        0 & amp; & amp;
        void 0 !== arguments[0] ? arguments[0] : 1,
            n = arguments.length & gt;
        1 & amp; & amp;
        void 0 !== arguments[1] ? arguments[1] : 0;
        if (1 === t) {
    ...
    function _(t, n, r) {
        ...
        for (var i = [], o = 0; o & lt; e; o++) i.push(A(t, n[o], r[o]));
        return i
    }
    ...
    function T(n, r, e, i, o) {
        var u, a = "@" === e[0],
            ...
            f = M[e],
            s = m;
        switch (a ? (u = e.substr(1), e = u.replace(F, P)) : l & amp; & amp;
            (e = e.substr(1)), t(f)) {
            case "function":
            ...
            case "string":
                ...
                break;
            case "object":
                if ((s = q(i, B(f.i), f.f)) & amp; & amp;
                    "function" == typeof f.u) return f.u(r, s, e, a, n)
        }
        return s ? function(t, n, r) {
            ...
            if (Array.isArray(n)) {
                ...
                return function(e) {
                    var o = r(e);
                    if (null == o)
                        for (var u = 0; u & lt; i; u++) t[u].removeAttribute(n);
                    else
                        for (var a = 0; a & lt; i; a++) t[a].setAttribute(n, o)
                }
            }
            return function(e) {
                var i = r(e);
    ...
    function z(t, n) {
        ...
        return r ? function(t, n) {
            var r = arguments.length & gt;
            2 & amp; & amp;
            void 0 !== arguments[2] ? arguments[2] : 1 / 0,
                e = arguments.length & gt;
            3 & amp; & amp;
            void 0 !== arguments[3] ? arguments[3] : 1,
                i = arguments.length & gt;
            4 & amp; & amp;
            void 0 !== arguments[4] & amp; & amp;
            arguments[4],
                o = arguments.length & gt;
            5 & amp; & amp;
            void 0 !== arguments[5] ? arguments[5] : 1,
                u = t.length,
                a = e & gt;
            0 ? n : 0;
            i & amp; & amp;
                    ...
                    if (t._rollingBack) {
                        ...
                        if (t.iterations & gt; 0 & amp; & amp; - 1 === t.fill) {
                            var g = t.iterations * t.duration,
                                p = g == a;
                            a = p ? 0 : a, t.offset = p ? 0 : t.offset, d = a & gt;
                            g
                        }
                        a & gt;
                        0 & amp; & amp;
                        t.offset & gt; = a & amp; & amp;
                        !d ? t._id = window.requestAnimationFrame(e) : t.stop()
                    }
                }))
            }
        }, {
                ...
                void 0 !== arguments[0] ? arguments[0] : 0,
                    ...
                    o = function o(u) {
                        ...
                        if (a & gt; r + l & amp; & amp; !t._rollingBack) {
                            t.offset = a, r = a;
                            for (var f = t._animations, s = f.length, c = 0, h = 0; h & lt; s; h++) i[h] ? c++ : (i[h] =
                                f[h](a, t.direction), i[h] & amp; & amp; c++);
    ...
    ! function() {
        for (var t = 0, n = ["ms", "moz", "webkit", "o"], r = 0; r & lt; n.length & amp; & amp; !window.requestAnimationFrame; ++r)
    ...
    function U(t) {
        ...
        return t & amp; & amp;
        t.length ? t.map(Q).join(n) : ""
    }

    function V(t) {
        return t ? null == t.a || t.a & gt; = 1 ? "rgb(" + t.r + "," + t.g + "," + t.b + ")" : "rgba(" + t.r + "," + t
    ...
    var $ = {
        ...
        rt = function() {
            function t() {
                ...
                3 & amp; & amp;
                void 0 !== arguments[3] ? arguments[3] : 1,
                    u = arguments.length & gt;
                4 & amp; & amp;
                void 0 !== arguments[4] ? arguments[4] : 0,
                    a = arguments.length & gt;
                5 & amp; & amp;
            ...
            return e(t, [{
                ...
                value: function(t, n) {
                    if (n %= 360, (t %= 360) || n) {
                        var r = this.m,
                            ...
                            u = r[3];
                        t & amp; & amp;
                        (t = K(t * X), r[2] += e * t, r[3] += i * t), n & amp; & amp;
                        (n = K(n * X), r[0] += o * n, r[
                ...
                value: function() {
                    ...
                    var f = 0;
                    return i[1][1] & lt;
                    0 ? (f = Z(i[1][1]) * tt, i[0][1] & lt; 0 & amp; & amp;
                            (f = 360 - f)) : f = J(i[0][1]) *
                        tt, u & amp; & amp;
                    (f = -f), a = W(a, nt(i[0][0] * i[0][0] + i[0][1] * i[0][1])) * tt, u & amp; & amp;
                    (a = -
                        a), {
                        origin: {
                            x: r[4],
                ...
                value: function() {
                    ...
                    (this.s = "matrix(" + this.m.map(it).join(" ") + ")"), this.s
                }
            }]), t
        }(),
        et = /\.0+$/;
    ...
    function vt(t, n, r, e) {
        var i = arguments.length & gt;
        4 & amp; & amp;
        void 0 !== arguments[4] ? arguments[4] : 1,
            o = ht(t, n, r, e),
            u = ct(o);
        try {
            return u(i)
    ...
    function Ft(t, n, r, e, i, o, u, a) {
        return n = function(t, n, r) {
            ...
            function(e) {
                var i, o = r(e, t, Pt);
                return o ? "c" === o.t ? V(o.v) : "g" === o.t ? (n[o.r] & amp; & amp;

                    function(t, n) {
                        for (var r = 0, e = t.length; r & lt; e; r++) t[r].setAttribute("stop-color", V(n[r]))
    ...
    var Bt = {
        ...
        "stroke-dasharray": {
            ...
            i: function(t, n, r) {
                ...
                for (var f = [], s = 0; s & lt; u; s++) f.push(g(w(t, n[s], r[s]), 6));
                return f
            }
        },
        opacity: jt,
        transform: function(n, r, e, i) {
            ...
            var o = function(t, i, o) {
                ...
                3 & amp; & amp;
                void 0 !== arguments[3] ? arguments[3] : null;
                return n[t] ? e(i, n[t], o) : r & amp; & amp;
                r[t] ? r[t] : u
            };
            return r & amp; & amp;
            r.a & amp; & amp;
