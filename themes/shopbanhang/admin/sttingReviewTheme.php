...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="row">
        ...
        <ul class="nav nav-tabs" role="tablist">
          <li class="nav-item">
            <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-home" aria-controls="navs-top-home" aria-selected="true">
              Nhận xét từ các KOL, KOC
            </button>
          </li>
          <li class="nav-item">
            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-product1" aria-controls="navs-top-info" aria-selected="false">
              Sản phẩm 1
            </button>
          </li>
          <li class="nav-item">
            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-product2" aria-controls="navs-top-info" aria-selected="false">
             Sản phẩm 2
           </button>
         </li>
         <li class="nav-item">
          <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-product3" aria-controls="navs-top-info" aria-selected="false">
           Sản phẩm 3
         </button>
       </li>
       <li class="nav-item">
           <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-product4" aria-controls="navs-top-info" aria-selected="false">
         Sản phẩm 4
          </button>
        </li>
   ...
   <div class="card-body tab-content ">
    ...
    <div class="tab-pane fade" id="navs-top-product1" role="tabpanel">
      <div class="card-body row ">
    ...
    <div class="tab-pane fade" id="navs-top-product2" role="tabpanel">
      <div class="card-body row ">
    ...
    <div class="tab-pane fade" id="navs-top-product3" role="tabpanel">
      <div class="card-body row ">
        <div class="mb-3 col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
          <label class="form-label" for="basic-default-fullname">tên sản phẩn  </label>
    ...
    <div class="tab-pane fade" id="navs-top-product4" role="tabpanel">
      <div class="card-body row ">
