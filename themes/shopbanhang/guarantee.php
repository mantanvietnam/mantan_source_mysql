        ...
        <div id="policy">
            <div class="container">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="chinh-sach-bao-mat" >Chính sách bảo hành</a></li>
                    <li ><a href="huong-dan-kich-hoat-bao-hanh" class="active">Hướng dẫn kích hoạt bảo hành</a></li>
                </ul>
