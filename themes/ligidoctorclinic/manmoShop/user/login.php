...
?>
    ...
    <div class="page-breadcrumb">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="rs clsH3Blog">Đăng nhập tài khoản</h1>
                    <ul class="list-inline rs">
                        <li class="list-inline-item">Nếu chưa có tài khoản hãy <a style="color:red;font-weight:bold" href="/register">ĐĂNG KÝ</a></li>
                    </ul>
                </div>
            </div>
        </div>
                                    ...
                                    <form action="" method="post" class="col-lg-12 col-md-12">
                                        <div class="sidebar__widget">
                                            <div class="sidebar__box">
                                                <div class="sidebar__title">Thông tin đăng nhập</div>
                                            </div>
                                                ...
                                                <p style="margin-top: 20px;margin-bottom:0"><a href="/">Quên mật khẩu?</a></p>
                                                <button style="margin-top: 20px" class="btn btn--box btn--small btn--radius btn--green btn--green-hover-black btn--uppercase font--semi-bold" type="submit">Đăng nhập</button> 
                                        </div>
