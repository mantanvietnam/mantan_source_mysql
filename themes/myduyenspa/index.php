<?php global $themeSettings;getHeader();?>
		<!------------------ end header ----------------->
		<section class="banner_main" id="sumenh" style="background-image: url(<?php echo @$setting['video']; ?>);background-size: 100%;
    background-repeat: no-repeat;">
			<!-- <video autoplay loop muted>
				...
				<div class="container">
					<div class="text-center text width100 textSlide">
						<?php echo @$setting['textSlide']; ?>
					</div>
				</div>
		</section>
		<div class="elementor-shape elementor-shape-bottom song1" data-negative="false" style="margin-top: -47px">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-sm-12 col-12 img_myduyen">
							<a href="#" class="">
								<img src="<?php echo @$setting['avatar']; ?>" alt="" style="width:85%;height: auto;">
							</a>
		...
		<section class="section3">
			<div class="container">
				<div class="vemyduyen">
					<h1>MỌI NGƯỜI NÓI GÌ VỀ <span style="color: #B43600"><?php echo @$setting['fullName']; ?></span></h1>
				</div>
		...
		<section class="section4" id="hethong" style="background-image: url('<?php echo @$setting['imageStatic']; ?>') !important; background-repeat: round;">
			<div class="container">
				<div class="row" id="counter">
					<div class="col-md-3 text-center">
						<div class="textspan counter-value"  data-count="<?php echo @$setting['numberStatic1']; ?>">
							<span><?php echo @$setting['numberStatic1']; ?></span>
							<span>+</span>
						</div>
						<div class="textspan1"><h3><?php echo @$setting['nameStatic1']; ?></h3></div>
					</div>
					<div class="col-md-3 text-center">
						<div class="textspan counter-value"  data-count="<?php echo @$setting['numberStatic2']; ?>">
							<span><?php echo @$setting['numberStatic2']; ?></span>
							<span>+</span>
						</div>
						<div class="textspan1"><h3><?php echo @$setting['nameStatic2']; ?></h3></div>
					</div>
					<div class="col-md-3 text-center">
						<div class="textspan counter-value" data-count="<?php echo @$setting['numberStatic3']; ?>">
							<span><?php echo @$setting['numberStatic3']; ?></span>
							<span>%</span>
						</div>
						<div class="textspan1"><h3><?php echo @$setting['nameStatic3']; ?></h3></div>
					</div>
					<div class="col-md-3 text-center">
						<div class="textspan counter-value" data-count="<?php echo @$setting['numberStatic4']; ?>">
							<span><?php echo @$setting['numberStatic4']; ?></span>
							<span>%</span>
						</div>
						<div class="textspan1"><h3><?php echo @$setting['nameStatic4']; ?></h3></div>
					</div>
				</div>
			</div>	
		</section>
	...
	<!-- <section class="section-6 " id="tintuc">
        <div class="diary sec-6 ">
            <h1 class="title text-center " style="padding: 20px; ">Chia sẻ
                <span class="sign">
                    Facebook
            ...
            <div class="container ">
                <div class="row mg-0 ">
                   <?php
                       /* global $modelNotice;
                        $news= getPostFacebook(4);

                        if(!empty($news)){
                            foreach($news as $item){
                                
                                echo '<div class="col-md-6 sec-6-post animate__animated" style="margin-bottom: 15px;">
                                        <div class="wrapper box " style="width: 100%;overflow: hidden;">
                                            <div class="content-post">
                                                <div class="fb-post" data-width="500" data-href="'.$item['link'].'"></div>
                                            </div>
                                        </div>
                                    </div>
                                    ';
