...
<body>
  <div>
    <!-- contact -->
     <div class='content-center text-white bg-green contact'>
        <span class="">Hotline Mộc Miên: 0123 456 789</span>
     </div>
     <!-- responsive search -->
    ...
    <div class="container header-container">
      <!-- logo -->
      <div>
        <img src="<?= $urlThemeActive?>/assets/images/logo.png" alt="logo">
      </div>
    ...
    <div class='px-5 banner-slider'>
      <div class="swiper mySwiper">
        <div class="swiper-wrapper">
          <div class="swiper-slide slider-img-container">
            <img src="<?= $urlThemeActive?>/assets/images/slide1.png"  />
          </div>
          <div class="swiper-slide slider-img-container">
            <img src="<?= $urlThemeActive?>/assets/images/slide1.png"  />
          </div>
    ...
    <!-- chính sách -->
     <div class='delivary-container'>
      <div class='container delivary-container-2 justify-content-md-between'>
        <div class='delivary'>
          <div>
            <img src="<?= $urlThemeActive?>/assets/images/car.png" alt="">
          </div>
          <div class='delivary-title-container'>
            <span class='text-1'>HỖ TRỢ PHÍ GIAO HÀNG</span>
            <span class='text-2'>Cho hoá đơn trên 200.000đ</span>
          </div>
        </div>
        <div class='delivary'>
          <div>
          ...
          <div class='delivary-title-container'>
            <span class='text-1'>100% CHÍNH HÃNG</span>
            <span class='text-2'>Đảm bảo nguồn gốc & chất lượng</span>
          </div>
        </div>
        <div class='delivary'>
          <div>
          ...
          <div class='delivary-title-container'>
            <span class='text-1'>THANH TOÁN LINH HOẠT</span>
            <span class='text-2'>Thanh toán online hoặc COD</span>
          </div>
        </div>
      </div>
     </div>
        ...
        <div class='container pt-5 pb-5'>
          <div class='row'>
            <div class="col-lg-3 col-12 footer-frist-container d-flex flex-column">
              <div class='gap-3 d-flex align-items-center'>
                <div><img src="<?= $urlThemeActive?>/assets/images/logo.png" alt="logo"></div>
              </div>
              <div class='mt-4 mb-3 bestnew-info'>
                <div class='gap-3 bn-contacts'>
                  <div class='bn-contact'>
                    <span>123 Main Street, Hometown, USA</span>
                  </div>
                  <div class='bn-contact'>
                    <span>minhtuanvinhomes@gmail.com</span>
                  </div>
                  <div class='bn-contact'>
                    <span>084.936.8668</span>
                  </div>
                </div>
              </div>
            </div>
            <div class="gap-3 text-white col-lg-3 col-6 d-flex flex-column footer-mid">
              <h2>VỀ MỘC MIÊN</h2>
              <span>Câu truyện thương hiệu</span>
            ...
            <div class="gap-3 text-white col-lg-3 col-6 d-flex flex-column footer-mid">
              ...
              <div class='gap-2 d-flex'>
                <a href="" class='social-icon'><img src="<?= $urlThemeActive?>/assets/images/insta.png" alt="insta"></a>
                <a href="" class='social-icon'><img src="<?= $urlThemeActive?>/assets/images/fb.png" alt="fb"></a>
                <a href="" class='social-icon'><img src="<?= $urlThemeActive?>/assets/images/linkedin.png" alt="linkedin"></a>
                <a href="" class='social-icon'><img src="<?= $urlThemeActive?>/assets/images/yt.png" alt="youtube"></a>
              </div>
            </div>
          </div>
  ...
  <script src="<?= $urlThemeActive?>/scripts/index.js"></script>
</html>